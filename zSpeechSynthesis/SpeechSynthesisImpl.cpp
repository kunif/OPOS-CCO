/****************************************************************************
**
** SpeechSynthesisImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSSpeechSynthesis");

// Control Object description and version.
char g_ControlDescription[] = "OPOS SpeechSynthesis Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSSpeechSynthesis::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "Speak",
        #define nDISpeak 17
    "SpeakImmediate",
        #define nDISpeakImmediate 18
    "StopCurrentSpeaking",
        #define nDIStopCurrentSpeaking 19
    "StopSpeaking",
        #define nDIStopSpeaking 20
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS SpeechSynthesis.
//===========================================================================
...
COPOSSpeechSynthesis::COPOSSpeechSynthesis()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSSpeechSynthesis >(this) )
{
}

//===========================================================================

HRESULT COPOSSpeechSynthesis::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSSpeechSynthesis::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSSpeechSynthesis::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSPEECHSYNTHESIS2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSSpeechSynthesis::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSpeechSynthesis::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSpeechSynthesis::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSSpeechSynthesis::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSSpeechSynthesis::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SPCH );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SPCH), hRC );
...
STDMETHODIMP COPOSSpeechSynthesis::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSpeechSynthesis::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSpeechSynthesis::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSpeechSynthesis::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSSpeechSynthesis::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSpeechSynthesis::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSpeechSynthesis::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSSpeechSynthesis::ResetStatistics( 
...
STDMETHODIMP COPOSSpeechSynthesis::RetrieveStatistics( 
...
STDMETHODIMP COPOSSpeechSynthesis::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSpeechSynthesis::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSSpeechSynthesis::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSpeechSynthesis::Speak( 
    /*[in]*/ BSTR Text, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Text, hRC );
    return DoInvoke( DEBUGPARAM("Speak") hRC, &Var, 1, nDISpeak, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::SpeakImmediate( 
    /*[in]*/ BSTR Text, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Text, hRC );
    return DoInvoke( DEBUGPARAM("SpeakImmediate") hRC, &Var, 1, nDISpeakImmediate, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::StopCurrentSpeaking( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StopCurrentSpeaking") S_OK, NULL, 0, nDIStopCurrentSpeaking, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::StopSpeaking( 
    /*[in]*/ LONG OutputID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( OutputID );
    return DoInvoke( DEBUGPARAM("StopSpeaking") S_OK, &Var, 1, nDIStopSpeaking, pRC );
}
...
STDMETHODIMP COPOSSpeechSynthesis::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSSpeechSynthesis::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSSpeechSynthesis::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSSpeechSynthesis::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSSpeechSynthesis::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSSpeechSynthesis::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSSpeechSynthesis::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSSpeechSynthesis::get_CapLanguage( /*[out, retval]*/ VARIANT_BOOL* pCapLanguage )
{
    return GetOposProp( DEBUGPARAM("CapLanguage") PIDXSpch_CapLanguage, pCapLanguage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_CapPitch( /*[out, retval]*/ VARIANT_BOOL* pCapPitch )
{
    return GetOposProp( DEBUGPARAM("CapPitch") PIDXSpch_CapPitch, pCapPitch, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_CapSpeed( /*[out, retval]*/ VARIANT_BOOL* pCapSpeed )
{
    return GetOposProp( DEBUGPARAM("CapSpeed") PIDXSpch_CapSpeed, pCapSpeed, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_CapVoice( /*[out, retval]*/ VARIANT_BOOL* pCapVoice )
{
    return GetOposProp( DEBUGPARAM("CapVoice") PIDXSpch_CapVoice, pCapVoice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_CapVolume( /*[out, retval]*/ VARIANT_BOOL* pCapVolume )
{
    return GetOposProp( DEBUGPARAM("CapVolume") PIDXSpch_CapVolume, pCapVolume, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_Language( /*[out, retval]*/ BSTR* pLanguage )
{
    return GetOposProp( DEBUGPARAM("Language") PIDXSpch_Language, pLanguage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSpeechSynthesis::put_Language( /*[in]*/ BSTR Language )
{
    return SetOposProp( DEBUGPARAM("Language") PIDXSpch_Language, Language, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_LanguageList( /*[out, retval]*/ BSTR* pLanguageList )
{
    return GetOposProp( DEBUGPARAM("LanguageList") PIDXSpch_LanguageList, pLanguageList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_OutputIDList( /*[out, retval]*/ BSTR* pOutputIDList )
{
    return GetOposProp( DEBUGPARAM("OutputIDList") PIDXSpch_OutputIDList, pOutputIDList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_Pitch( /*[out, retval]*/ LONG* pPitch )
{
    return GetOposProp( DEBUGPARAM("Pitch") PIDXSpch_Pitch, pPitch, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSpeechSynthesis::put_Pitch( /*[in]*/ LONG Pitch )
{
    return SetOposProp( DEBUGPARAM("Pitch") PIDXSpch_Pitch, Pitch, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_Speed( /*[out, retval]*/ LONG* pSpeed )
{
    return GetOposProp( DEBUGPARAM("Speed") PIDXSpch_Speed, pSpeed, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSpeechSynthesis::put_Speed( /*[in]*/ LONG Speed )
{
    return SetOposProp( DEBUGPARAM("Speed") PIDXSpch_Speed, Speed, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_Voice( /*[out, retval]*/ BSTR* pVoice )
{
    return GetOposProp( DEBUGPARAM("Voice") PIDXSpch_Voice, pVoice, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSpeechSynthesis::put_Voice( /*[in]*/ BSTR Voice )
{
    return SetOposProp( DEBUGPARAM("Voice") PIDXSpch_Voice, Voice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_VoiceList( /*[out, retval]*/ BSTR* pVoiceList )
{
    return GetOposProp( DEBUGPARAM("VoiceList") PIDXSpch_VoiceList, pVoiceList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSpeechSynthesis::get_Volume( /*[out, retval]*/ LONG* pVolume )
{
    return GetOposProp( DEBUGPARAM("Volume") PIDXSpch_Volume, pVolume, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSpeechSynthesis::put_Volume( /*[in]*/ LONG Volume )
{
    return SetOposProp( DEBUGPARAM("Volume") PIDXSpch_Volume, Volume, 16 /*MinorVersion*/ );
}
...
void COPOSSpeechSynthesis::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_SpeechSynthesis.log");
...
#define OPOSCCOCLASS COPOSSpeechSynthesis
#define RCSTRACENAME "OposCCO_SpeechSynthesis"
...
void COPOSSpeechSynthesis::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSSpeechSynthesis::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSSpeechSynthesis::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSSpeechSynthesis::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
