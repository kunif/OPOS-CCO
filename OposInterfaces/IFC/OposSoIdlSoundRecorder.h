//*************************************************************************
//** OPOS SoundRecorder SO Interface
//*************************************************************************

[
    uuid(CCBE0430-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSSoundRecorderSO 1.16 Interface")
]
dispinterface IOPOSSoundRecorderSO
{
    properties:
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG StartRecording([in] BSTR FileName, [in] VARIANT_BOOL OverWrite, [in] LONG RecordingTime);
        [id(82)] LONG StopRecording(void);
};
