//*************************************************************************
//** OPOS FiscalPrinter Constants
//*************************************************************************

typedef [helpstring("OPOS FiscalPrinter Constants")]
enum
{
    FPTR_S_JOURNAL                            = 1,
    FPTR_S_RECEIPT                            = 2,
    ...
    FPTR_CID_SECOND                           = 2,
    FPTR_CID_SINGLE                           = 3,
    FPTR_CC_BRAZIL                            = 0x00000001,
    FPTR_CC_GREECE                            = 0x00000002,
    FPTR_CC_HUNGARY                           = 0x00000004,
    FPTR_CC_ITALY                             = 0x00000008,
    FPTR_CC_POLAND                            = 0x00000010,
    FPTR_CC_TURKEY                            = 0x00000020,
    FPTR_CC_RUSSIA                            = 0x00000040,
    FPTR_CC_BULGARIA                          = 0x00000080,
    FPTR_CC_ROMANIA                           = 0x00000100,
    FPTR_CC_CZECH_REPUBLIC                    = 0x00000200,
    FPTR_CC_UKRAINE                           = 0x00000400,
    FPTR_CC_SWEDEN                            = 0x00000800,
    FPTR_CC_GERMANY                           = 0x00001000,
    FPTR_CC_OTHER                             = 0x40000000,
    FPTR_DT_CONF                              = 1,
    FPTR_DT_EOD                               = 2,
    FPTR_DT_RESET                             = 3,
    FPTR_DT_RTC                               = 4,
    FPTR_DT_VAT                               = 5,
    FPTR_DT_START                             = 6,
    FPTR_DT_TICKET_START                      = 7,
    FPTR_DT_TICKET_END                        = 8,
    FPTR_EL_NONE                              = 1,
