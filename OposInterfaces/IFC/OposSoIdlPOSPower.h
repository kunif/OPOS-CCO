//*************************************************************************
//** OPOS POSPower SO Interface
//*************************************************************************

[
    uuid(CCBE0220-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSPOSPowerSO 1.16 Interface")
]
dispinterface IOPOSPOSPowerSO
{
    ...
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG RestartPOS(void);
        [id(82)] LONG ShutdownPOS(void);
        [id(83)] LONG StandbyPOS([in] LONG Reason);
        [id(84)] LONG SuspendPOS([in] LONG Reason);
};
