/****************************************************************************
**
** IndividualRecognitionImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_IndividualRecognition.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_IndividualRecognition.log")
...
#include "IndividualRecognitionDefs.h"
...
#include "IndividualRecognitionCP.h"
...
// The class...
class ATL_NO_VTABLE COPOSIndividualRecognition :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSIndividualRecognition, &IID_IOPOSIndividualRecognition, &LIBID_OposIndividualRecognition_CCO>,
    public CComControl<COPOSIndividualRecognition>,
    public IPersistStreamInitImpl<COPOSIndividualRecognition>,
    public IOleControlImpl<COPOSIndividualRecognition>,
    public IOleObjectImpl<COPOSIndividualRecognition>,
    public IOleInPlaceActiveObjectImpl<COPOSIndividualRecognition>,
    public IViewObjectExImpl<COPOSIndividualRecognition>,
    public IOleInPlaceObjectWindowlessImpl<COPOSIndividualRecognition>,
    public IConnectionPointContainerImpl<COPOSIndividualRecognition>,
    public IPersistStorageImpl<COPOSIndividualRecognition>,
    public ISpecifyPropertyPagesImpl<COPOSIndividualRecognition>,
    public IQuickActivateImpl<COPOSIndividualRecognition>,
    public IDataObjectImpl<COPOSIndividualRecognition>,
    public IProvideClassInfo2Impl<&CLSID_OPOSIndividualRecognition, &DIID__IOPOSIndividualRecognitionEvents, &LIBID_OposIndividualRecognition_CCO>,
    public IObjectSafetyImpl<COPOSIndividualRecognition, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSIndividualRecognition>,
    public CComCoClass<COPOSIndividualRecognition, &CLSID_OPOSIndividualRecognition>,
    public CProxy_IOPOSEvents< COPOSIndividualRecognition >
{
public:
// Constructor / FinalConstruct / Destructor.
    COPOSIndividualRecognition();
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSINDIVIDUALRECOGNITION)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSIndividualRecognition)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSIndividualRecognition)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSIndividualRecognition, IOPOSIndividualRecognition)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSIndividualRecognition_1_16, IOPOSIndividualRecognition)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSIndividualRecognition)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSIndividualRecognition)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSIndividualRecognitionEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSIndividualRecognition)
    CHAIN_MSG_MAP(CComControl<COPOSIndividualRecognition>)
...
protected:
    #include "IndividualRecognitionEvent.h"
...
// Release 1.16
    ...
    STDMETHOD(ClearInputProperties)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapIndividualList)( /*[out, retval]*/ BSTR* pCapIndividualList );
    STDMETHOD(get_IndividualIDs)( /*[out, retval]*/ BSTR* pIndividualIDs );
    STDMETHOD(get_IndividualRecognitionFilter)( /*[out, retval]*/ BSTR* pIndividualRecognitionFilter );
    STDMETHOD(put_IndividualRecognitionFilter)( /*[in]*/ BSTR IndividualRecognitionFilter );
    STDMETHOD(get_IndividualRecognitionInformation)( /*[out, retval]*/ BSTR* pIndividualRecognitionInformation );
};


// End IndividualRecognitionImpl.h
