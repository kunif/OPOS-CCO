//*************************************************************************
//** OPOS VoiceRecognition SO Interface
//*************************************************************************

[
    uuid(CCBE0460-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSVoiceRecognitionSO 1.16 Interface")
]
dispinterface IOPOSVoiceRecognitionSO
{
    properties:
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG StartHearingFree([in] BSTR Langage);
        [id(82)] LONG StartHearingSentence([in] BSTR Langage, [in] BSTR WordList, [in] BSTR PatternList);
        [id(83)] LONG StartHearingWord([in] BSTR Langage, [in] BSTR WordList);
        [id(84)] LONG StartHearingYesNo([in] BSTR Langage);
        [id(85)] LONG StopHearing(void);
};
