//*************************************************************************
//** OPOS SpeechSynthesis SO Interface
//*************************************************************************

[
    uuid(CCBE0440-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSSpeechSynthesisSO 1.16 Interface")
]
dispinterface IOPOSSpeechSynthesisSO
{
    properties:
    methods:
     ...
     // [id(11)] LONG ClearInputProperties(void);
        ...
        [id(81)] LONG Speak([in] BSTR Text);
        [id(82)] LONG SpeakImmediate([in] BSTR Text);
        [id(83)] LONG StopCurrentSpeaking(void);
        [id(84)] LONG StopSpeaking([in] LONG OutputID);
};
