...
IF NOT EXIST "%ProgramFiles%\OPOS\OpenPosFor.NET" GOTO w32SOCommon
...
DEL /F /Q "%ProgramFiles%\OPOS\??Register???.bat"
...
IF NOT EXIST "%ProgramFiles(x86)%\OPOS\OpenPosFor.NET" GOTO x86SOCommon
@ECHO Unregistration of PIA files
...
DEL /F /Q "%ProgramFiles(x86)%\OPOS\??Register???.bat"
...
DEL /F /Q "%ProgramW6432%\OPOS\??Register???.bat"
