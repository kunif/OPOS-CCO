/****************************************************************************
**
** SoundRecorderImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSSoundRecorder");

// Control Object description and version.
char g_ControlDescription[] = "OPOS SoundRecorder Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSSoundRecorder::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "StartRecording",
        #define nDIStartRecording 18
    "StopRecording",
        #define nDIStopRecording 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS SoundRecorder.
//===========================================================================
...
COPOSSoundRecorder::COPOSSoundRecorder()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSSoundRecorder >(this) )
{
}

//===========================================================================

HRESULT COPOSSoundRecorder::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSSoundRecorder::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSSoundRecorder::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSOUNDRECORDER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSSoundRecorder::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSoundRecorder::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSoundRecorder::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSSoundRecorder::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSSoundRecorder::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SREC );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SREC), hRC );
...
STDMETHODIMP COPOSSoundRecorder::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundRecorder::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundRecorder::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundRecorder::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSSoundRecorder::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundRecorder::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSoundRecorder::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSSoundRecorder::ResetStatistics( 
...
STDMETHODIMP COPOSSoundRecorder::RetrieveStatistics( 
...
STDMETHODIMP COPOSSoundRecorder::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundRecorder::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSSoundRecorder::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundRecorder::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSoundRecorder::StartRecording( 
    /*[in]*/ BSTR FileName, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    return DoInvoke( DEBUGPARAM("StartRecording") hRC, Vars, 3, nDIStartRecording, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::StopRecording( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StopRecording") S_OK, NULL, 0, nDIStopRecording, pRC );
}
...
STDMETHODIMP COPOSSoundRecorder::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSSoundRecorder::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSSoundRecorder::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSSoundRecorder::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSSoundRecorder::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSSoundRecorder::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSSoundRecorder::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSSoundRecorder::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
    return GetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, pAutoDisable, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
    return SetOposProp( DEBUGPARAM("AutoDisable") PIDX_AutoDisable, AutoDisable, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSSoundRecorder::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSSoundRecorder::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSSoundRecorder::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
    return GetOposProp( DEBUGPARAM("DataCount") PIDX_DataCount, pDataCount, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
    return GetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, pDataEventEnabled, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
    return SetOposProp( DEBUGPARAM("DataEventEnabled") PIDX_DataEventEnabled, DataEventEnabled, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSSoundRecorder::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSSoundRecorder::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSSoundRecorder::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSSoundRecorder::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSSoundRecorder::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSSoundRecorder::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSSoundRecorder::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSSoundRecorder::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSSoundRecorder::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSSoundRecorder::get_CapAssociatedHardTotalsDevice( /*[out, retval]*/ BSTR* pCapAssociatedHardTotalsDevice )
{
    return GetOposProp( DEBUGPARAM("CapAssociatedHardTotalsDevice") PIDXSrec_CapAssociatedHardTotalsDevice, pCapAssociatedHardTotalsDevice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_CapChannel( /*[out, retval]*/ VARIANT_BOOL* pCapChannel )
{
    return GetOposProp( DEBUGPARAM("CapChannel") PIDXSrec_CapChannel, pCapChannel, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_CapRecordingLevel( /*[out, retval]*/ VARIANT_BOOL* pCapRecordingLevel )
{
    return GetOposProp( DEBUGPARAM("CapRecordingLevel") PIDXSrec_CapRecordingLevel, pCapRecordingLevel, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_CapSamplingRate( /*[out, retval]*/ VARIANT_BOOL* pCapSamplingRate )
{
    return GetOposProp( DEBUGPARAM("CapSamplingRate") PIDXSrec_CapSamplingRate, pCapSamplingRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_CapSoundType( /*[out, retval]*/ VARIANT_BOOL* pCapSoundType )
{
    return GetOposProp( DEBUGPARAM("CapSoundType") PIDXSrec_CapSoundType, pCapSoundType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_CapStorage( /*[out, retval]*/ LONG* pCapStorage )
{
    return GetOposProp( DEBUGPARAM("CapStorage") PIDXSrec_CapStorage, pCapStorage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_Channel( /*[out, retval]*/ BSTR* pChannel )
{
    return GetOposProp( DEBUGPARAM("Channel") PIDXSrec_Channel, pChannel, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_Channel( /*[in]*/ BSTR Channel )
{
    return SetOposProp( DEBUGPARAM("Channel") PIDXSrec_Channel, Channel, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_ChannelList( /*[out, retval]*/ BSTR* pChannelList )
{
    return GetOposProp( DEBUGPARAM("ChannelList") PIDXSrec_ChannelList, pChannelList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_RecordingLevel( /*[out, retval]*/ LONG* pRecordingLevel )
{
    return GetOposProp( DEBUGPARAM("RecordingLevel") PIDXSrec_RecordingLevel, pRecordingLevel, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_RecordingLevel( /*[in]*/ LONG RecordingLevel )
{
    return SetOposProp( DEBUGPARAM("RecordingLevel") PIDXSrec_RecordingLevel, RecordingLevel, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_RemainingRecordingTimeInSec( /*[out, retval]*/ LONG* pRemainingRecordingTimeInSec )
{
    return GetOposProp( DEBUGPARAM("RemainingRecordingTimeInSec") PIDXSrec_RemainingRecordingTimeInSec, pRemainingRecordingTimeInSec, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_SamplingRate( /*[out, retval]*/ BSTR* pSamplingRate )
{
    return GetOposProp( DEBUGPARAM("SamplingRate") PIDXSrec_SamplingRate, pSamplingRate, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_SamplingRate( /*[in]*/ BSTR SamplingRate )
{
    return SetOposProp( DEBUGPARAM("SamplingRate") PIDXSrec_SamplingRate, SamplingRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_SamplingRateList( /*[out, retval]*/ BSTR* pSamplingRateList )
{
    return GetOposProp( DEBUGPARAM("SamplingRateList") PIDXSrec_SamplingRateList, pSamplingRateList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_SoundData( /*[out, retval]*/ BSTR* pSoundData )
{
    return GetOposProp( DEBUGPARAM("SoundData") PIDXSrec_SoundData, pSoundData, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_SoundType( /*[out, retval]*/ BSTR* pSoundType )
{
    return GetOposProp( DEBUGPARAM("SoundType") PIDXSrec_SoundType, pSoundType, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_SoundType( /*[in]*/ BSTR SoundType )
{
    return SetOposProp( DEBUGPARAM("SoundType") PIDXSrec_SoundType, SoundType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_SoundTypeList( /*[out, retval]*/ BSTR* pSoundTypeList )
{
    return GetOposProp( DEBUGPARAM("SoundTypeList") PIDXSrec_SoundTypeList, pSoundTypeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundRecorder::get_Storage( /*[out, retval]*/ LONG* pStorage )
{
    return GetOposProp( DEBUGPARAM("Storage") PIDXSrec_Storage, pStorage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundRecorder::put_Storage( /*[in]*/ LONG Storage )
{
    return SetOposProp( DEBUGPARAM("Storage") PIDXSrec_Storage, Storage, 16 /*MinorVersion*/ );
}
...
void COPOSSoundRecorder::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_SoundRecorder.log");
...
#define OPOSCCOCLASS COPOSSoundRecorder
#define RCSTRACENAME "OposCCO_SoundRecorder"
...
void COPOSSoundRecorder::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSSoundRecorder::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSSoundRecorder::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSSoundRecorder::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
