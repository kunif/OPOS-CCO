...
dispinterface IOPOSCashDrawerSO
{
    ...
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG OpenDrawer(void);
        [id(82)] LONG WaitForDrawerClose([in] LONG BeepTimeout, [in] LONG BeepFrequency, [in] LONG BeepDuration, [in] LONG BeepDelay);
};
