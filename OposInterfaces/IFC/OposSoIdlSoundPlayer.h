//*************************************************************************
//** OPOS SoundPlayer SO Interface
//*************************************************************************

[
    uuid(CCBE0420-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSSoundPlayerSO 1.16 Interface")
]
dispinterface IOPOSSoundPlayerSO
{
    properties:
    methods:
     ...
     // [id(11)] LONG ClearInputProperties(void);
        ...
        [id(81)] LONG PlaySound([in] BSTR FileName, [in] VARIANT_BOOL Loop);
        [id(82)] LONG StopSound([in] LONG OutputID);
};
