//*************************************************************************
//** OPOS VideoCapture SO Interface
//*************************************************************************

[
    uuid(CCBE0450-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSVideoCaptureSO 1.16 Interface")
]
dispinterface IOPOSVideoCaptureSO
{
    properties:
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG StartVideo([in] BSTR FileName, [in] VARIANT_BOOL OverWrite, [in] LONG RecordingTime);
        [id(82)] LONG StopVideo(void);
        [id(83)] LONG TakePhoto([in] BSTR FileName, [in] VARIANT_BOOL OverWrite, [in] LONG Timeout);
};
