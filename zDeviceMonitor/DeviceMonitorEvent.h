/****************************************************************************
**
** DeviceMonitorEvent.h -- OPOS event firing support.
**
**    This file is included into the DeviceMonitor Control Object's main
...
/////////////////////////////////////////////////////////////////////////////
    ...
    STDMETHOD( SOData )(long Status)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_DataEvent( Status );
        else
...
//===========================================================================
    ...
    STDMETHOD( SODirectIO )(long EventNumber, long* pData, BSTR* pString)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_DirectIOEvent( EventNumber, pData, pString );
        else
        {
...
//===========================================================================
                ...
                long ErrorLocus, long* pErrorResponse)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_ErrorEvent( ResultCode, ResultCodeExtended,
...
//===========================================================================
    ...
    STDMETHOD( SOStatusUpdate)(long Data)
    {
        ...
        if ( _Event_ControlThreadID == GetCurrentThreadId() )
            CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_StatusUpdateEvent( Data );
        else
...
/////////////////////////////////////////////////////////////////////////////
    ...
    {
        COPOSDeviceMonitor* pThis;

        // On window creation, save our window instance into user window space.
        if ( uMsg == WM_CREATE )
        {
            pThis = (COPOSDeviceMonitor*) ((LPCREATESTRUCT) lParam)->lpCreateParams;
        ...
        {
            pThis = (COPOSDeviceMonitor*) ::GetWindowLongPtr( hwnd, 0 );
            if ( pThis != 0 &&
        ...
        case WMU_DATA_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_DataEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
        ...
        case WMU_DIRECT_IO_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_DirectIOEvent(
        ...
        case WMU_ERROR_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_ErrorEvent (
        ...
        case WMU_STATUS_UPDATE_EVENT:
            {
                if ( FireEventSetup() )
                {
                    ...
                    CProxy_IOPOSEvents< COPOSDeviceMonitor >::Fire_StatusUpdateEvent(
                        (long) wParam );
                    FireEventCleanup();
                }
                break;
