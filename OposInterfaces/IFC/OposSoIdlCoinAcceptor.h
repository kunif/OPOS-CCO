//*************************************************************************
//** OPOS CoinAcceptor SO Interface
//*************************************************************************

[
    uuid(CCBE0300-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSCoinAcceptorSO 1.15 Interface")
]
dispinterface IOPOSCoinAcceptorSO
{
    ...
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(83)] LONG EndDeposit([in] LONG Success);
        [id(84)] LONG FixDeposit(void);
        [id(85)] LONG PauseDeposit([in] LONG Control);
        [id(86)] LONG ReadCashCounts([out] BSTR* pCashCounts, [out] VARIANT_BOOL* pDiscrepancy);
};
