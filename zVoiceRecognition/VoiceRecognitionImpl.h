/****************************************************************************
**
** VoiceRecognitionImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_VoiceRecognition.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_VoiceRecognition.log")
...
#include "VoiceRecognitionDefs.h"
...
// The class...
class ATL_NO_VTABLE COPOSVoiceRecognition :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSVoiceRecognition, &IID_IOPOSVoiceRecognition, &LIBID_OposVoiceRecognition_CCO>,
    public CComControl<COPOSVoiceRecognition>,
    public IPersistStreamInitImpl<COPOSVoiceRecognition>,
    public IOleControlImpl<COPOSVoiceRecognition>,
    public IOleObjectImpl<COPOSVoiceRecognition>,
    public IOleInPlaceActiveObjectImpl<COPOSVoiceRecognition>,
    public IViewObjectExImpl<COPOSVoiceRecognition>,
    public IOleInPlaceObjectWindowlessImpl<COPOSVoiceRecognition>,
    public IConnectionPointContainerImpl<COPOSVoiceRecognition>,
    public IPersistStorageImpl<COPOSVoiceRecognition>,
    public ISpecifyPropertyPagesImpl<COPOSVoiceRecognition>,
    public IQuickActivateImpl<COPOSVoiceRecognition>,
    public IDataObjectImpl<COPOSVoiceRecognition>,
    public IProvideClassInfo2Impl<&CLSID_OPOSVoiceRecognition, &DIID__IOPOSVoiceRecognitionEvents, &LIBID_OposVoiceRecognition_CCO>,
    public IObjectSafetyImpl<COPOSVoiceRecognition, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSVoiceRecognition>,
    public CComCoClass<COPOSVoiceRecognition, &CLSID_OPOSVoiceRecognition>,
    public CProxy_IOPOSEvents< COPOSVoiceRecognition >
{
public:
// Constructor / FinalConstruct / Destructor.
    COPOSVoiceRecognition();
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSVOICERECOGNITION)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSVoiceRecognition)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSVoiceRecognition)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSVoiceRecognition, IOPOSVoiceRecognition)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSVoiceRecognition_1_16, IOPOSVoiceRecognition)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSVoiceRecognition)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSVoiceRecognition)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSVoiceRecognitionEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSVoiceRecognition)
    CHAIN_MSG_MAP(CComControl<COPOSVoiceRecognition>)
...
protected:
    #include "VoiceRecognitionEvent.h"
...
// Release 1.16
    ...
    STDMETHOD(get_HearingDataPattern)( /*[out, retval]*/ BSTR* pHearingDataPattern );
    STDMETHOD(get_HearingDataWord)( /*[out, retval]*/ BSTR* pHearingDataWord );
    STDMETHOD(get_HearingDataWordList)( /*[out, retval]*/ BSTR* pHearingDataWordList );
    STDMETHOD(get_HearingResult)( /*[out, retval]*/ LONG* pHearingResult );
    STDMETHOD(get_HearingStatus)( /*[out, retval]*/ LONG* pHearingStatus );
    STDMETHOD(get_LanguageList)( /*[out, retval]*/ BSTR* pLanguageList );
    STDMETHOD(StartHearingFree)( 
        /*[in]*/ BSTR Language, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StartHearingSentence)( 
        /*[in]*/ BSTR Language, 
        /*[in]*/ BSTR WordList, 
        /*[in]*/ BSTR PatternList, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StartHearingWord)( 
        /*[in]*/ BSTR Language, 
        /*[in]*/ BSTR WordList, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StartHearingYesNo)( 
        /*[in]*/ BSTR Language, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StopHearing)( 
        /*[out, retval]*/ long* pRC );
};


// End VoiceRecognitionImpl.h
