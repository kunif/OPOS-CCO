/****************************************************************************
**
** GestureControlImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSGestureControl");

// Control Object description and version.
char g_ControlDescription[] = "OPOS GestureControl Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSGestureControl::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "CreateMotion",
        #define nDICreateMotion 17
    "CreatePose",
        #define nDICreatePose 18
    "GetPosition",
        #define nDIGetPosition 19
    "SetPosition",
        #define nDISetPosition 20
    "SetSpeed",
        #define nDISetSpeed 21
    "StartMotion",
        #define nDIStartMotion 22
    "StartPose",
        #define nDIStartPose 23
    "StopControl",
        #define nDIStopControl 24
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS GestureControl.
//===========================================================================
...
COPOSGestureControl::COPOSGestureControl()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSGestureControl >(this) )
{
}

//===========================================================================

HRESULT COPOSGestureControl::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSGestureControl::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSGestureControl::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSGESTURECONTROL2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSGestureControl::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGestureControl::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGestureControl::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSGestureControl::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSGestureControl::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_GCTL );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_GCTL), hRC );
...
STDMETHODIMP COPOSGestureControl::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGestureControl::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGestureControl::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGestureControl::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSGestureControl::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGestureControl::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSGestureControl::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSGestureControl::ResetStatistics( 
...
STDMETHODIMP COPOSGestureControl::RetrieveStatistics( 
...
STDMETHODIMP COPOSGestureControl::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGestureControl::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSGestureControl::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGestureControl::CreateMotion( 
    /*[in]*/ BSTR FileName, 
    /*[in]*/ BSTR PoseList, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[0].SetBSTR( PoseList, hRC );
    return DoInvoke( DEBUGPARAM("CreateMotion") hRC, Vars, 2, nDICreateMotion, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::CreatePose( 
    /*[in]*/ BSTR FileName, 
    /*[in]*/ LONG Time, 
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetBSTR( FileName, hRC );
    Vars[0].SetLONG( Time );
    return DoInvoke( DEBUGPARAM("CreatePose") hRC, Vars, 2, nDICreatePose, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::GetPosition( 
    /*[in]*/ BSTR JointID, 
    /*[out]*/ LONG* pPosition, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( JointID, hRC );
    Vars[0].SetLONG_Ptr( pPosition, hRC );
    return DoInvoke( DEBUGPARAM("GetPosition") hRC, Vars, 2, nDIGetPosition, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::SetPosition( 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[3];
    HRESULT hRC = S_OK;
    Vars[2].SetBSTR( PositionList, hRC );
    Vars[1].SetLONG( Time );
    Vars[0].SetVARIANT_BOOL( Absolute );
    return DoInvoke( DEBUGPARAM("SetPosition") hRC, Vars, 3, nDISetPosition, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::SetSpeed( 
    /*[in]*/ BSTR SpeedList, 
    /*[in]*/ LONG Time, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( SpeedList, hRC );
    Vars[0].SetLONG( Time );
    return DoInvoke( DEBUGPARAM("SetSpeed") hRC, Vars, 2, nDISetSpeed, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::StartMotion( 
    /*[in]*/ BSTR FileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    ...
    return DoInvoke( DEBUGPARAM("StartMotion") hRC, &Var, 1, nDIStartMotion, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::StartPose( 
    /*[in]*/ BSTR FileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( FileName, hRC );
    return DoInvoke( DEBUGPARAM("StartPose") hRC, &Var, 1, nDIStartPose, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::StopControl( 
    /*[in]*/ LONG OutputID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( OutputID );
    return DoInvoke( DEBUGPARAM("StopControl") S_OK, &Var, 1, nDIStopControl, pRC );
}
...
STDMETHODIMP COPOSGestureControl::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSGestureControl::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSGestureControl::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSGestureControl::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSGestureControl::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSGestureControl::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSGestureControl::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSGestureControl::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSGestureControl::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSGestureControl::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSGestureControl::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSGestureControl::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSGestureControl::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSGestureControl::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSGestureControl::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSGestureControl::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSGestureControl::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSGestureControl::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSGestureControl::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSGestureControl::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSGestureControl::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSGestureControl::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSGestureControl::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSGestureControl::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSGestureControl::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSGestureControl::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSGestureControl::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSGestureControl::get_AutoMode( /*[out, retval]*/ BSTR* pAutoMode )
{
    return GetOposProp( DEBUGPARAM("AutoMode") PIDXGctl_AutoMode, pAutoMode, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGestureControl::put_AutoMode( /*[in]*/ BSTR AutoMode )
{
    return SetOposProp( DEBUGPARAM("AutoMode") PIDXGctl_AutoMode, AutoMode, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_AutoModeList( /*[out, retval]*/ BSTR* pAutoModeList )
{
    return GetOposProp( DEBUGPARAM("AutoModeList") PIDXGctl_AutoModeList, pAutoModeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapAssociatedHardTotalsDevice( /*[out, retval]*/ BSTR* pCapAssociatedHardTotalsDevice )
{
    return GetOposProp( DEBUGPARAM("CapAssociatedHardTotalsDevice") PIDXGctl_CapAssociatedHardTotalsDevice, pCapAssociatedHardTotalsDevice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapMotion( /*[out, retval]*/ VARIANT_BOOL* pCapMotion )
{
    return GetOposProp( DEBUGPARAM("CapMotion") PIDXGctl_CapMotion, pCapMotion, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapMotionCreation( /*[out, retval]*/ VARIANT_BOOL* pCapMotionCreation )
{
    return GetOposProp( DEBUGPARAM("CapMotionCreation") PIDXGctl_CapMotionCreation, pCapMotionCreation, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapPose( /*[out, retval]*/ VARIANT_BOOL* pCapPose )
{
    return GetOposProp( DEBUGPARAM("CapPose") PIDXGctl_CapPose, pCapPose, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapPoseCreation( /*[out, retval]*/ VARIANT_BOOL* pCapPoseCreation )
{
    return GetOposProp( DEBUGPARAM("CapPoseCreation") PIDXGctl_CapPoseCreation, pCapPoseCreation, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_CapStorage( /*[out, retval]*/ LONG* pCapStorage )
{
    return GetOposProp( DEBUGPARAM("CapStorage") PIDXGctl_CapStorage, pCapStorage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_JointList( /*[out, retval]*/ BSTR* pJointList )
{
    return GetOposProp( DEBUGPARAM("JointList") PIDXGctl_JointList, pJointList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_MotionList( /*[out, retval]*/ BSTR* pMotionList )
{
    return GetOposProp( DEBUGPARAM("MotionList") PIDXGctl_MotionList, pMotionList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_PoseCreationMode( /*[out, retval]*/ VARIANT_BOOL* pPoseCreationMode )
{
    return GetOposProp( DEBUGPARAM("PoseCreationMode") PIDXGctl_PoseCreationMode, pPoseCreationMode, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGestureControl::put_PoseCreationMode( /*[in]*/ VARIANT_BOOL PoseCreationMode )
{
    return SetOposProp( DEBUGPARAM("PoseCreationMode") PIDXGctl_PoseCreationMode, PoseCreationMode, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_PoseList( /*[out, retval]*/ BSTR* pPoseList )
{
    return GetOposProp( DEBUGPARAM("PoseList") PIDXGctl_PoseList, pPoseList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGestureControl::get_Storage( /*[out, retval]*/ LONG* pStorage )
{
    return GetOposProp( DEBUGPARAM("Storage") PIDXGctl_Storage, pStorage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGestureControl::put_Storage( /*[in]*/ LONG Storage )
{
    return SetOposProp( DEBUGPARAM("Storage") PIDXGctl_Storage, Storage, 16 /*MinorVersion*/ );
}
...
void COPOSGestureControl::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_GestureControl.log");
...
#define OPOSCCOCLASS COPOSGestureControl
#define RCSTRACENAME "OposCCO_GestureControl"
...
void COPOSGestureControl::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSGestureControl::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSGestureControl::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSGestureControl::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
