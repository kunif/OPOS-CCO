/****************************************************************************
**
** SpeechSynthesisImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_SpeechSynthesis.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_SpeechSynthesis.log")
...
// The class...
class ATL_NO_VTABLE COPOSSpeechSynthesis :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSSpeechSynthesis, &IID_IOPOSSpeechSynthesis, &LIBID_OposSpeechSynthesis_CCO>,
    public CComControl<COPOSSpeechSynthesis>,
    public IPersistStreamInitImpl<COPOSSpeechSynthesis>,
    public IOleControlImpl<COPOSSpeechSynthesis>,
    public IOleObjectImpl<COPOSSpeechSynthesis>,
    public IOleInPlaceActiveObjectImpl<COPOSSpeechSynthesis>,
    public IViewObjectExImpl<COPOSSpeechSynthesis>,
    public IOleInPlaceObjectWindowlessImpl<COPOSSpeechSynthesis>,
    public IConnectionPointContainerImpl<COPOSSpeechSynthesis>,
    public IPersistStorageImpl<COPOSSpeechSynthesis>,
    public ISpecifyPropertyPagesImpl<COPOSSpeechSynthesis>,
    public IQuickActivateImpl<COPOSSpeechSynthesis>,
    public IDataObjectImpl<COPOSSpeechSynthesis>,
    public IProvideClassInfo2Impl<&CLSID_OPOSSpeechSynthesis, &DIID__IOPOSSpeechSynthesisEvents, &LIBID_OposSpeechSynthesis_CCO>,
    public IObjectSafetyImpl<COPOSSpeechSynthesis, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSSpeechSynthesis>,
    public CComCoClass<COPOSSpeechSynthesis, &CLSID_OPOSSpeechSynthesis>,
    public CProxy_IOPOSEvents< COPOSSpeechSynthesis >
{
public:
// Constructor / FinalConstruct / Destructor.
    COPOSSpeechSynthesis();
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSSPEECHSYNTHESIS)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSSpeechSynthesis)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSSpeechSynthesis)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSSpeechSynthesis, IOPOSSpeechSynthesis)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSSpeechSynthesis_1_16, IOPOSSpeechSynthesis)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSSpeechSynthesis)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSSpeechSynthesis)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSSpeechSynthesisEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSSpeechSynthesis)
    CHAIN_MSG_MAP(CComControl<COPOSSpeechSynthesis>)
...
// Release 1.16
    ...
    STDMETHOD(UpdateFirmware)( 
        /*[in]*/ BSTR FirmwareFileName, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_CapLanguage)( /*[out, retval]*/ VARIANT_BOOL* pCapLanguage );
    STDMETHOD(get_CapPitch)( /*[out, retval]*/ VARIANT_BOOL* pCapPitch );
    STDMETHOD(get_CapSpeed)( /*[out, retval]*/ VARIANT_BOOL* pCapSpeed );
    STDMETHOD(get_CapVoice)( /*[out, retval]*/ VARIANT_BOOL* pCapVoice );
    STDMETHOD(get_CapVolume)( /*[out, retval]*/ VARIANT_BOOL* pCapVolume );
    STDMETHOD(get_Language)( /*[out, retval]*/ BSTR* pLanguage );
    STDMETHOD(put_Language)( /*[in]*/ BSTR Language );
    STDMETHOD(get_LanguageList)( /*[out, retval]*/ BSTR* pLanguageList );
    STDMETHOD(get_OutputIDList)( /*[out, retval]*/ BSTR* pOutputIDList );
    STDMETHOD(get_Pitch)( /*[out, retval]*/ LONG* pPitch );
    STDMETHOD(put_Pitch)( /*[in]*/ LONG Pitch );
    STDMETHOD(get_Speed)( /*[out, retval]*/ LONG* pSpeed );
    STDMETHOD(put_Speed)( /*[in]*/ LONG Speed );
    STDMETHOD(get_Voice)( /*[out, retval]*/ BSTR* pVoice );
    STDMETHOD(put_Voice)( /*[in]*/ BSTR Voice );
    STDMETHOD(get_VoiceList)( /*[out, retval]*/ BSTR* pVoiceList );
    STDMETHOD(get_Volume)( /*[out, retval]*/ LONG* pVolume );
    STDMETHOD(put_Volume)( /*[in]*/ LONG Volume );
    STDMETHOD(Speak)( 
        /*[in]*/ BSTR Text, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(SpeakImmediate)( 
        /*[in]*/ BSTR Text, 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StopCurrentSpeaking)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(StopSpeaking)( 
        /*[in]*/ LONG OutputID, 
        /*[out, retval]*/ long* pRC );
};


// End SpeechSynthesisImpl.h
