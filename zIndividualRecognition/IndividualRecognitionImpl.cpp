/****************************************************************************
**
** IndividualRecognitionImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSIndividualRecognition");

// Control Object description and version.
char g_ControlDescription[] = "OPOS IndividualRecognition Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSIndividualRecognition::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS IndividualRecognition.
//===========================================================================
...
COPOSIndividualRecognition::COPOSIndividualRecognition()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSIndividualRecognition >(this) )
{
}

//===========================================================================

HRESULT COPOSIndividualRecognition::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSIndividualRecognition::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSIndividualRecognition::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSINDIVIDUALRECOGNITION2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSIndividualRecognition::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSIndividualRecognition::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSIndividualRecognition::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSIndividualRecognition::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSIndividualRecognition::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_IRCG );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_IRCG), hRC );
...
STDMETHODIMP COPOSIndividualRecognition::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSIndividualRecognition::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSIndividualRecognition::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSIndividualRecognition::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSIndividualRecognition::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSIndividualRecognition::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSIndividualRecognition::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSIndividualRecognition::ResetStatistics( 
...
STDMETHODIMP COPOSIndividualRecognition::RetrieveStatistics( 
...
STDMETHODIMP COPOSIndividualRecognition::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSIndividualRecognition::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSIndividualRecognition::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSIndividualRecognition::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSIndividualRecognition::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSIndividualRecognition::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSIndividualRecognition::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSIndividualRecognition::get_CapIndividualList( /*[out, retval]*/ BSTR* pCapIndividualList )
{
    return GetOposProp( DEBUGPARAM("CapIndividualList") PIDXIrcg_CapIndividualList, pCapIndividualList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSIndividualRecognition::get_IndividualIDs( /*[out, retval]*/ BSTR* pIndividualIDs )
{
    return GetOposProp( DEBUGPARAM("IndividualIDs") PIDXIrcg_IndividualIDs, pIndividualIDs, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSIndividualRecognition::get_IndividualRecognitionFilter( /*[out, retval]*/ BSTR* pIndividualRecognitionFilter )
{
    return GetOposProp( DEBUGPARAM("IndividualRecognitionFilter") PIDXIrcg_IndividualRecognitionFilter, pIndividualRecognitionFilter, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSIndividualRecognition::put_IndividualRecognitionFilter( /*[in]*/ BSTR IndividualRecognitionFilter )
{
    return SetOposProp( DEBUGPARAM("IndividualRecognitionFilter") PIDXIrcg_IndividualRecognitionFilter, IndividualRecognitionFilter, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSIndividualRecognition::get_IndividualRecognitionInformation( /*[out, retval]*/ BSTR* pIndividualRecognitionInformation )
{
    return GetOposProp( DEBUGPARAM("IndividualRecognitionInformation") PIDXIrcg_IndividualRecognitionInformation, pIndividualRecognitionInformation, 16 /*MinorVersion*/ );
}
...
void COPOSIndividualRecognition::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_IndividualRecognition.log");
...
#define OPOSCCOCLASS COPOSIndividualRecognition
#define RCSTRACENAME "OposCCO_IndividualRecognition"
...
void COPOSIndividualRecognition::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSIndividualRecognition::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSIndividualRecognition::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSIndividualRecognition::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
...
// End IndividualRecognitionImpl.cpp
