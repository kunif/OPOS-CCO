...
XCOPY ??RegisterCCO.bat "%ProgramFiles%\OPOS" /S/V/H/R/Y
...
XCOPY ??RegisterCCO.bat "%ProgramW6432%\OPOS" /S/V/H/R/Y
XCOPY ??RegisterCCO.bat "%ProgramFiles(x86)%\OPOS" /S/V/H/R/Y
