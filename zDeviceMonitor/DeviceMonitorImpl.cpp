/****************************************************************************
**
** DeviceMonitorImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSDeviceMonitor");

// Control Object description and version.
char g_ControlDescription[] = "OPOS DeviceMonitor Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSDeviceMonitor::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "AddMonitoringDevice",
        #define nDIAddMonitoringDevice 18
    "ClearMonitoringDevice",
        #define nDIClearMonitoringDevice 19
    "DeleteMonitoringDevice",
        #define nDIDeleteMonitoringDevice 20
    "GetDeviceValue",
        #define nDIGetDeviceValue 21
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS DeviceMonitor.
//===========================================================================
...
COPOSDeviceMonitor::COPOSDeviceMonitor()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSDeviceMonitor >(this) )
{
}

//===========================================================================

HRESULT COPOSDeviceMonitor::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSDeviceMonitor::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSDeviceMonitor::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSDEVICEMONITOR2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSDeviceMonitor::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSDeviceMonitor::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSDeviceMonitor::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSDeviceMonitor::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSDeviceMonitor::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_DMON );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_DMON), hRC );
...
STDMETHODIMP COPOSDeviceMonitor::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceMonitor::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceMonitor::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceMonitor::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSDeviceMonitor::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceMonitor::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSDeviceMonitor::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSDeviceMonitor::ResetStatistics( 
...
STDMETHODIMP COPOSDeviceMonitor::RetrieveStatistics( 
...
STDMETHODIMP COPOSDeviceMonitor::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceMonitor::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSDeviceMonitor::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceMonitor::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSDeviceMonitor::AddMonitoringDevice( 
    /*[in]*/ BSTR DeviceID, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[5];
    HRESULT hRC = S_OK;
    Vars[4].SetBSTR( DeviceID, hRC );
    Vars[3].SetLONG( MonitoringMode );
    Vars[2].SetLONG( Boundary );
    Vars[1].SetLONG( SubBoundary );
    Vars[0].SetLONG( IntervalTime );
    return DoInvoke( DEBUGPARAM("AddMonitoringDevice") hRC, Vars, 5, nDIAddMonitoringDevice, pRC );
}

//===========================================================================

STDMETHODIMP COPOSDeviceMonitor::ClearMonitoringDevice( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("ClearMonitoringDevice") S_OK, NULL, 0, nDIClearMonitoringDevice, pRC );
}

//===========================================================================

STDMETHODIMP COPOSDeviceMonitor::DeleteMonitoringDevice( 
    /*[in]*/ BSTR DeviceID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( DeviceID, hRC );
    return DoInvoke( DEBUGPARAM("DeleteMonitoringDevice") hRC, &Var, 1, nDIDeleteMonitoringDevice, pRC );
}

//===========================================================================

STDMETHODIMP COPOSDeviceMonitor::GetDeviceValue( 
    /*[in]*/ BSTR DeviceID, 
    /*[out]*/ LONG* pValue, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( DeviceID, hRC );
    Vars[0].SetLONG_Ptr( pValue, hRC );
    return DoInvoke( DEBUGPARAM("GetDeviceValue") hRC, Vars, 2, nDIGetDeviceValue, pRC );
}
...
STDMETHODIMP COPOSDeviceMonitor::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceMonitor::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSDeviceMonitor::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSDeviceMonitor::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSDeviceMonitor::get_DeviceData( /*[out, retval]*/ BSTR* pDeviceData )
{
    return GetOposProp( DEBUGPARAM("DeviceData") PIDXDmon_DeviceData, pDeviceData, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSDeviceMonitor::get_DeviceList( /*[out, retval]*/ BSTR* pDeviceList )
{
    return GetOposProp( DEBUGPARAM("DeviceList") PIDXDmon_DeviceList, pDeviceList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSDeviceMonitor::get_MonitoringDeviceList( /*[out, retval]*/ BSTR* pMonitoringDeviceList )
{
    return GetOposProp( DEBUGPARAM("MonitoringDeviceList") PIDXDmon_MonitoringDeviceList, pMonitoringDeviceList, 16 /*MinorVersion*/ );
}
...
void COPOSDeviceMonitor::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_DeviceMonitor.log");
...
#define OPOSCCOCLASS COPOSDeviceMonitor
#define RCSTRACENAME "OposCCO_DeviceMonitor"
...
void COPOSDeviceMonitor::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSDeviceMonitor::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSDeviceMonitor::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSDeviceMonitor::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
