...
dispinterface IOPOSPointCardRWSO
{
    ...
    methods:
        ...
        [id(83)] LONG CleanCard(void);
        [id(84)] LONG ClearPrintWrite([in] LONG Kind, [in] LONG Hposition, [in] LONG Vposition, [in] LONG Width, [in] LONG Height);
        [id(85)] LONG EndInsertion(void);
        [id(86)] LONG EndRemoval(void);
        [id(87)] LONG PrintWrite([in] LONG Kind, [in] LONG Hposition, [in] LONG Vposition, [in] BSTR Data);
        [id(88)] LONG RotatePrint([in] LONG Rotation);
        [id(89)] LONG ValidateData([in] BSTR Data);
};
