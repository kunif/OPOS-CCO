...
dispinterface IOPOSBumpBarSO
{
    ...
    methods:
     ...
     // [id(11)] LONG ClearInputProperties(void);
        ...
        [id(81)] LONG BumpBarSound([in] LONG Units, [in] LONG Frequency, [in] LONG Duration, [in] LONG NumberOfCycles, [in] LONG InterSoundWait);
        [id(82)] LONG SetKeyTranslation([in] LONG Units, [in] LONG ScanCode, [in] LONG LogicalKey);
};
