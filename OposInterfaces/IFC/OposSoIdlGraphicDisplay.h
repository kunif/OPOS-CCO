//*************************************************************************
//** OPOS GraphicDisplay SO Interface
//*************************************************************************

[
    uuid(CCBE0400-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSGraphicDisplaySO 1.16 Interface")
]
dispinterface IOPOSGraphicDisplaySO
{
    properties:
    methods:
     ...
     // [id(11)] LONG ClearInputProperties(void);
        ...
        [id(85)] LONG LoadURL([in] BSTR URL);
        [id(86)] LONG PlayVideo([in] BSTR FileName, [in] VARIANT_BOOL Loop);
        [id(87)] LONG StopVideo(void);
        [id(88)] LONG UpdateURLPage(void);
};
