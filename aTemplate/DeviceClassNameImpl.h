/****************************************************************************
**
** DeviceClassNameImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_DeviceClassName.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_DeviceClassName.log")
...
// The class...
class ATL_NO_VTABLE COPOSDeviceClassName :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSDeviceClassName, &IID_IOPOSDeviceClassName, &LIBID_OposDeviceClassName_CCO>,
    public CComControl<COPOSDeviceClassName>,
    public IPersistStreamInitImpl<COPOSDeviceClassName>,
    public IOleControlImpl<COPOSDeviceClassName>,
    public IOleObjectImpl<COPOSDeviceClassName>,
    public IOleInPlaceActiveObjectImpl<COPOSDeviceClassName>,
    public IViewObjectExImpl<COPOSDeviceClassName>,
    public IOleInPlaceObjectWindowlessImpl<COPOSDeviceClassName>,
    public IConnectionPointContainerImpl<COPOSDeviceClassName>,
    public IPersistStorageImpl<COPOSDeviceClassName>,
    public ISpecifyPropertyPagesImpl<COPOSDeviceClassName>,
    public IQuickActivateImpl<COPOSDeviceClassName>,
    public IDataObjectImpl<COPOSDeviceClassName>,
    public IProvideClassInfo2Impl<&CLSID_OPOSDeviceClassName, &DIID__IOPOSDeviceClassNameEvents, &LIBID_OposDeviceClassName_CCO>,
    public IObjectSafetyImpl<COPOSDeviceClassName, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSDeviceClassName>,
    public CComCoClass<COPOSDeviceClassName, &CLSID_OPOSDeviceClassName>,
    public CProxy_IOPOSEvents< COPOSDeviceClassName >
{
public:
// Constructor / FinalConstruct / Destructor.
    COPOSDeviceClassName();
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSDEVICECLASSNAME)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSDeviceClassName)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSDeviceClassName)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSDeviceClassName, IOPOSDeviceClassName)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSDeviceClassName_1_16, IOPOSDeviceClassName)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSDeviceClassName)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSDeviceClassName)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSDeviceClassNameEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSDeviceClassName)
    CHAIN_MSG_MAP(CComControl<COPOSDeviceClassName>)
...
protected:
    #include "DeviceClassNameEvent.h"
