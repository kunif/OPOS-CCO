/****************************************************************************
**
** GraphicDisplayImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSGraphicDisplay");

// Control Object description and version.
char g_ControlDescription[] = "OPOS GraphicDisplay Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSGraphicDisplay::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "GoURLForward",
        #define nDIGoURLForward 19
    "LoadImage",
        #define nDILoadImage 20
    "LoadURL",
        #define nDILoadURL 21
    "PlayVideo",
...
//   for each release.
// Followed by the initial minor release of the OPOS GraphicDisplay.
//===========================================================================
...
COPOSGraphicDisplay::COPOSGraphicDisplay()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSGraphicDisplay >(this) )
{
}

//===========================================================================

HRESULT COPOSGraphicDisplay::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSGraphicDisplay::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSGraphicDisplay::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSGRAPHICDISPLAY2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSGraphicDisplay::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGraphicDisplay::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSGraphicDisplay::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSGraphicDisplay::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSGraphicDisplay::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_GDSP );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_GDSP), hRC );
...
STDMETHODIMP COPOSGraphicDisplay::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGraphicDisplay::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGraphicDisplay::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSGraphicDisplay::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSGraphicDisplay::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGraphicDisplay::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSGraphicDisplay::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSGraphicDisplay::ResetStatistics( 
...
STDMETHODIMP COPOSGraphicDisplay::RetrieveStatistics( 
...
STDMETHODIMP COPOSGraphicDisplay::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGraphicDisplay::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSGraphicDisplay::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSGraphicDisplay::GoURLBack( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("GoURLBack") S_OK, NULL, 0, nDIGoURLBack, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::GoURLForward( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("GoURLForward") S_OK, NULL, 0, nDIGoURLForward, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::LoadImage( 
    /*[in]*/ BSTR FileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    ...
    return DoInvoke( DEBUGPARAM("LoadImage") hRC, &Var, 1, nDILoadImage, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::LoadURL( 
    /*[in]*/ BSTR URL, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( URL, hRC );
    return DoInvoke( DEBUGPARAM("LoadURL") hRC, &Var, 1, nDILoadURL, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::PlayVideo( 
    /*[in]*/ BSTR FileName, 
    ...
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( FileName, hRC );
    Vars[0].SetVARIANT_BOOL( Loop );
    return DoInvoke( DEBUGPARAM("PlayVideo") hRC, Vars, 2, nDIPlayVideo, pRC );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::StopVideo( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSGraphicDisplay::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSGraphicDisplay::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSGraphicDisplay::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSGraphicDisplay::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSGraphicDisplay::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
    return GetOposProp( DEBUGPARAM("OutputID") PIDX_OutputID, pOutputID, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSGraphicDisplay::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSGraphicDisplay::get_Brightness( /*[out, retval]*/ LONG* pBrightness )
{
    return GetOposProp( DEBUGPARAM("Brightness") PIDXGdsp_Brightness, pBrightness, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_Brightness( /*[in]*/ LONG Brightness )
{
    return SetOposProp( DEBUGPARAM("Brightness") PIDXGdsp_Brightness, Brightness, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapAssociatedHardTotalsDevice( /*[out, retval]*/ BSTR* pCapAssociatedHardTotalsDevice )
{
    return GetOposProp( DEBUGPARAM("CapAssociatedHardTotalsDevice") PIDXGdsp_CapAssociatedHardTotalsDevice, pCapAssociatedHardTotalsDevice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapBrightness( /*[out, retval]*/ VARIANT_BOOL* pCapBrightness )
{
    return GetOposProp( DEBUGPARAM("CapBrightness") PIDXGdsp_CapBrightness, pCapBrightness, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapImageType( /*[out, retval]*/ VARIANT_BOOL* pCapImageType )
{
    return GetOposProp( DEBUGPARAM("CapImageType") PIDXGdsp_CapImageType, pCapImageType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapStorage( /*[out, retval]*/ LONG* pCapStorage )
{
    return GetOposProp( DEBUGPARAM("CapStorage") PIDXGdsp_CapStorage, pCapStorage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapURLBack( /*[out, retval]*/ VARIANT_BOOL* pCapURLBack )
{
    return GetOposProp( DEBUGPARAM("CapURLBack") PIDXGdsp_CapURLBack, pCapURLBack, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapURLForward( /*[out, retval]*/ VARIANT_BOOL* pCapURLForward )
{
    return GetOposProp( DEBUGPARAM("CapURLForward") PIDXGdsp_CapURLForward, pCapURLForward, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapVideoType( /*[out, retval]*/ VARIANT_BOOL* pCapVideoType )
{
    return GetOposProp( DEBUGPARAM("CapVideoType") PIDXGdsp_CapVideoType, pCapVideoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_CapVolume( /*[out, retval]*/ VARIANT_BOOL* pCapVolume )
{
    return GetOposProp( DEBUGPARAM("CapVolume") PIDXGdsp_CapVolume, pCapVolume, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_DisplayMode( /*[out, retval]*/ LONG* pDisplayMode )
{
    return GetOposProp( DEBUGPARAM("DisplayMode") PIDXGdsp_DisplayMode, pDisplayMode, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_DisplayMode( /*[in]*/ LONG DisplayMode )
{
    return SetOposProp( DEBUGPARAM("DisplayMode") PIDXGdsp_DisplayMode, DisplayMode, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_ImageType( /*[out, retval]*/ BSTR* pImageType )
{
    return GetOposProp( DEBUGPARAM("ImageType") PIDXGdsp_ImageType, pImageType, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_ImageType( /*[out, retval]*/ BSTR ImageType )
{
    return SetOposProp( DEBUGPARAM("ImageType") PIDXGdsp_ImageType, ImageType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_ImageTypeList( /*[out, retval]*/ BSTR* pImageTypeList )
{
    return GetOposProp( DEBUGPARAM("ImageTypeList") PIDXGdsp_ImageTypeList, pImageTypeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_LoadStatus( /*[out, retval]*/ LONG* pLoadStatus )
{
    return GetOposProp( DEBUGPARAM("LoadStatus") PIDXGdsp_LoadStatus, pLoadStatus, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_Storage( /*[out, retval]*/ LONG* pStorage )
{
    return GetOposProp( DEBUGPARAM("Storage") PIDXGdsp_Storage, pStorage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_Storage( /*[in]*/ LONG Storage )
{
    return SetOposProp( DEBUGPARAM("Storage") PIDXGdsp_Storage, Storage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_URL( /*[out, retval]*/ BSTR* pURL )
{
    return GetOposProp( DEBUGPARAM("URL") PIDXGdsp_URL, pURL, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_VideoType( /*[out, retval]*/ BSTR* pVideoType )
{
    return GetOposProp( DEBUGPARAM("VideoType") PIDXGdsp_VideoType, pVideoType, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_VideoType( /*[out, retval]*/ BSTR VideoType )
{
    return SetOposProp( DEBUGPARAM("VideoType") PIDXGdsp_VideoType, VideoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_VideoTypeList( /*[out, retval]*/ BSTR* pVideoTypeList )
{
    return GetOposProp( DEBUGPARAM("VideoTypeList") PIDXGdsp_VideoTypeList, pVideoTypeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSGraphicDisplay::get_Volume( /*[out, retval]*/ LONG* pVolume )
{
    return GetOposProp( DEBUGPARAM("Volume") PIDXGdsp_Volume, pVolume, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSGraphicDisplay::put_Volume( /*[in]*/ LONG Volume )
{
    return SetOposProp( DEBUGPARAM("Volume") PIDXGdsp_Volume, Volume, 16 /*MinorVersion*/ );
}
...
void COPOSGraphicDisplay::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_GraphicDisplay.log");
...
#define OPOSCCOCLASS COPOSGraphicDisplay
#define RCSTRACENAME "OposCCO_GraphicDisplay"
...
void COPOSGraphicDisplay::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSGraphicDisplay::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSGraphicDisplay::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSGraphicDisplay::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
