/****************************************************************************
**
** SoundPlayerImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_SoundPlayer.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_SoundPlayer.log")
...
// The class...
class ATL_NO_VTABLE COPOSSoundPlayer :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSSoundPlayer, &IID_IOPOSSoundPlayer, &LIBID_OposSoundPlayer_CCO>,
    public CComControl<COPOSSoundPlayer>,
    public IPersistStreamInitImpl<COPOSSoundPlayer>,
    public IOleControlImpl<COPOSSoundPlayer>,
    public IOleObjectImpl<COPOSSoundPlayer>,
    public IOleInPlaceActiveObjectImpl<COPOSSoundPlayer>,
    public IViewObjectExImpl<COPOSSoundPlayer>,
    public IOleInPlaceObjectWindowlessImpl<COPOSSoundPlayer>,
    public IConnectionPointContainerImpl<COPOSSoundPlayer>,
    public IPersistStorageImpl<COPOSSoundPlayer>,
    public ISpecifyPropertyPagesImpl<COPOSSoundPlayer>,
    public IQuickActivateImpl<COPOSSoundPlayer>,
    public IDataObjectImpl<COPOSSoundPlayer>,
    public IProvideClassInfo2Impl<&CLSID_OPOSSoundPlayer, &DIID__IOPOSSoundPlayerEvents, &LIBID_OposSoundPlayer_CCO>,
    public IObjectSafetyImpl<COPOSSoundPlayer, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSSoundPlayer>,
    public CComCoClass<COPOSSoundPlayer, &CLSID_OPOSSoundPlayer>,
    public CProxy_IOPOSEvents< COPOSSoundPlayer >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSSOUNDPLAYER)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSSoundPlayer)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSSoundPlayer)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSSoundPlayer, IOPOSSoundPlayer)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSSoundPlayer_1_16, IOPOSSoundPlayer)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSSoundPlayer)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSSoundPlayer)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSSoundPlayerEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSSoundPlayer)
    CHAIN_MSG_MAP(CComControl<COPOSSoundPlayer>)
...
// Release 1.16
    ...
    STDMETHOD(get_CapMultiPlay)( /*[out, retval]*/ VARIANT_BOOL* pCapMultiPlay );
    STDMETHOD(get_CapSoundTypeList)( /*[out, retval]*/ BSTR* pCapSoundTypeList );
    STDMETHOD(get_CapStorage)( /*[out, retval]*/ LONG* pCapStorage );
    STDMETHOD(get_CapVolume)( /*[out, retval]*/ VARIANT_BOOL* pCapVolume );
    STDMETHOD(get_DeviceSoundList)( /*[out, retval]*/ BSTR* pDeviceSoundList );
