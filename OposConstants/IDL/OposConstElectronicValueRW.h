...
enum
{
    ...
    EVRW_DL_NONE                              = 0,
    EVRW_DL_REPORTING                         = 1,
    EVRW_DL_SETTLEMENT                        = 2,
    EVRW_DL_REPORTING_SETTLEMENT              = 3,
    EVRW_LS_OK                                = 1,
    EVRW_LS_NEARFULL                          = 2,
    EVRW_LS_FULL                              = 3,
    EVRW_PAYMENT_LUMP                         = 10,
    EVRW_PAYMENT_BONUS_1                      = 21,
    EVRW_PAYMENT_BONUS_2                      = 22,
    EVRW_PAYMENT_BONUS_3                      = 23,
    EVRW_PAYMENT_BONUS_4                      = 24,
    EVRW_PAYMENT_BONUS_5                      = 25,
    EVRW_PAYMENT_INSTALLMENT_1                = 61,
    EVRW_PAYMENT_INSTALLMENT_2                = 62,
    EVRW_PAYMENT_INSTALLMENT_3                = 63,
    EVRW_PAYMENT_BONUS_COMBINATION_1          = 31,
    EVRW_PAYMENT_BONUS_COMBINATION_2          = 32,
    EVRW_PAYMENT_BONUS_COMBINATION_3          = 33,
    EVRW_PAYMENT_BONUS_COMBINATION_4          = 34,
    EVRW_PAYMENT_REVOLVING                    = 80,
    EVRW_PAYMENT_DEBIT                        = 110,
    EVRW_PAYMENT_ELECTRONIC_MONEY             = 111,
    EVRW_MEDIA_UNSPECIFIED                    = 0,
    EVRW_MEDIA_CREDIT                         = 1,
    EVRW_MEDIA_DEBIT                          = 2,
    EVRW_MEDIA_ELECTRONIC_MONEY               = 3,
    EVRW_TRANSACTION_SALES                    = 10,
    EVRW_TRANSACTION_VOID                     = 20,
    EVRW_TRANSACTION_REFUND                   = 21,
    EVRW_TRANSACTION_VOIDPRESALES             = 29,
    EVRW_TRANSACTION_COMPLETION               = 30,
    EVRW_TRANSACTION_PRESALES                 = 40,
    EVRW_TRANSACTION_CHECKCARD                = 41,
    EVRW_TRANSACTION_CASHDEPOSIT              = 50,
    ...
    EVRW_TAG_TT_WRITE                         = 9,
    EVRW_TAG_TT_COMPLETION                    = 10,
    EVRW_TAG_TT_PRE_SALES                     = 11,
    ...
    EVRW_TE_CONFIRM_SEARCH_TABLE              = 24,
    EVRW_TE_CONFIRM_PAYMENT_CONDITION         = 25,
    EVRW_TE_CONFIRM_AUTHORIZE                 = 26,
    EVRW_TE_NOTIFY_CHECK_CARD                 = 27,
    EVRW_TE_NOTIFY_SELECT_PAYMENT_CONDITION   = 28,
