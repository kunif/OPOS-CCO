//*************************************************************************
//** OPOS IndividualRecognition SO Interface
//*************************************************************************

[
    uuid(CCBE0410-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSIndividualRecognitionSO 1.16 Interface")
]
dispinterface IOPOSIndividualRecognitionSO
{
    properties:
    methods:
