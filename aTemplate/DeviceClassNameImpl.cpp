/****************************************************************************
**
** DeviceClassNameImpl.cpp -- Main control implementation file.
**
**     Date                   Modification                          Author
** -----------|----------------------------------------------------|----------
**  yyyy/mm/dd Initial Version from similar sources.                K. Fukuchi
**
*****************************************************************************
**
{{Begin License}}

Copyright yyyy Kunio Fukuchi
...
TCHAR g_WindowName[] = _T("HW_OPOSDeviceClassName");

// Control Object description and version.
char g_ControlDescription[] = "OPOS DeviceClassName Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSDeviceClassName::s_nInstances = 0;
...
//   for each release.
// Followed by the initial minor release of the OPOS DeviceClassName.
//===========================================================================
...
COPOSDeviceClassName::COPOSDeviceClassName()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSDeviceClassName >(this) )
{
}

//===========================================================================

HRESULT COPOSDeviceClassName::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSDeviceClassName::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSDeviceClassName::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSDEVICECLASSNAME2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSDeviceClassName::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSDeviceClassName::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSDeviceClassName::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSDeviceClassName::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSDeviceClassName::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_DEVICESHORTNAME );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_DEVICESHORTNAME), hRC );
...
STDMETHODIMP COPOSDeviceClassName::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceClassName::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceClassName::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceClassName::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSDeviceClassName::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceClassName::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSDeviceClassName::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSDeviceClassName::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSDeviceClassName::ResetStatistics( 
...
STDMETHODIMP COPOSDeviceClassName::RetrieveStatistics( 
...
STDMETHODIMP COPOSDeviceClassName::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceClassName::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSDeviceClassName::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSDeviceClassName::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSDeviceClassName::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSDeviceClassName::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSDeviceClassName::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSDeviceClassName::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSDeviceClassName::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSDeviceClassName::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSDeviceClassName::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSDeviceClassName::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSDeviceClassName::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSDeviceClassName::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSDeviceClassName::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSDeviceClassName::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSDeviceClassName::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSDeviceClassName::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSDeviceClassName::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSDeviceClassName::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSDeviceClassName::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSDeviceClassName::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSDeviceClassName::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSDeviceClassName::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSDeviceClassName::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSDeviceClassName::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSDeviceClassName::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSDeviceClassName::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSDeviceClassName::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSDeviceClassName::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSDeviceClassName::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
void COPOSDeviceClassName::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_DeviceClassName.log");
...
#define OPOSCCOCLASS COPOSDeviceClassName
#define RCSTRACENAME "OposCCO_DeviceClassName"
...
void COPOSDeviceClassName::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSDeviceClassName::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSDeviceClassName::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSDeviceClassName::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
