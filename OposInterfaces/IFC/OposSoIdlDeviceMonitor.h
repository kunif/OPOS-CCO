//*************************************************************************
//** OPOS DeviceMonitor SO Interface
//*************************************************************************

[
    uuid(CCBE0380-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSDeviceMonitorSO 1.16 Interface")
]
dispinterface IOPOSDeviceMonitorSO
{
    properties:
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG AddMonitoringDevice([in] BSTR DeviceID, [in] LONG MonitoringMode, [in] LONG Boundary, [in] LONG SubBoundary, [in] LONG IntervalTime);
        [id(82)] LONG ClearMonitoringDevice(void);
        [id(83)] LONG DeleteMonitoringDevice([in] BSTR DeviceID);
        [id(84)] LONG GetDeviceValue([in] BSTR DeviceID, [out] LONG* pValue);
};
