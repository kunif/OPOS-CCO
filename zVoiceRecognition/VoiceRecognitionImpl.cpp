/****************************************************************************
**
** VoiceRecognitionImpl.cpp -- Main control implementation file.
**
...
#include "VoiceRecognitionImpl.h"
...
TCHAR g_WindowName[] = _T("HW_OPOSVoiceRecognition");

// Control Object description and version.
char g_ControlDescription[] = "OPOS VoiceRecognition Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSVoiceRecognition::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "StartHearingFree",
        #define nDIStartHearingFree 18
    "StartHearingSentence",
        #define nDIStartHearingSentence 19
    "StartHearingWord",
        #define nDIStartHearingWord 20
    "StartHearingYesNo",
        #define nDIStartHearingYesNo 21
    "StopHearing",
        #define nDIStopHearing 22
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS VoiceRecognition.
//===========================================================================
...
COPOSVoiceRecognition::COPOSVoiceRecognition()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSVoiceRecognition >(this) )
{
}

//===========================================================================

HRESULT COPOSVoiceRecognition::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSVoiceRecognition::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSVoiceRecognition::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSVOICERECOGNITION2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSVoiceRecognition::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSVoiceRecognition::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSVoiceRecognition::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSVoiceRecognition::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSVoiceRecognition::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_VRCG );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_VRCG), hRC );
...
STDMETHODIMP COPOSVoiceRecognition::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVoiceRecognition::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVoiceRecognition::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVoiceRecognition::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSVoiceRecognition::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVoiceRecognition::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSVoiceRecognition::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSVoiceRecognition::ResetStatistics( 
...
STDMETHODIMP COPOSVoiceRecognition::RetrieveStatistics( 
...
STDMETHODIMP COPOSVoiceRecognition::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVoiceRecognition::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSVoiceRecognition::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVoiceRecognition::ClearInputProperties( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSVoiceRecognition::StartHearingFree( 
    /*[in]*/ BSTR Language, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Language, hRC );
    return DoInvoke( DEBUGPARAM("StartHearingFree") hRC, &Var, 1, nDIStartHearingFree, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::StartHearingSentence( 
    /*[in]*/ BSTR Language, 
    /*[in]*/ BSTR WordList, 
    /*[in]*/ BSTR PatternList, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[3];
    HRESULT hRC = S_OK;
    Vars[2].SetBSTR( Language, hRC );
    Vars[1].SetBSTR( WordList, hRC );
    Vars[0].SetBSTR( PatternList, hRC );
    return DoInvoke( DEBUGPARAM("StartHearingSentence") hRC, Vars, 3, nDIStartHearingSentence, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::StartHearingWord( 
    /*[in]*/ BSTR Language, 
    /*[in]*/ BSTR WordList, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Vars[2];
    HRESULT hRC = S_OK;
    Vars[1].SetBSTR( Language, hRC );
    Vars[0].SetBSTR( WordList, hRC );
    return DoInvoke( DEBUGPARAM("StartHearingWord") hRC, Vars, 2, nDIStartHearingWord, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::StartHearingYesNo( 
    /*[in]*/ BSTR Language, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    HRESULT hRC = S_OK;
    Var.SetBSTR( Language, hRC );
    return DoInvoke( DEBUGPARAM("StartHearingYesNo") hRC, &Var, 1, nDIStartHearingYesNo, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::StopHearing( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StopHearing") S_OK, NULL, 0, nDIStopHearing, pRC );
}
...
STDMETHODIMP COPOSVoiceRecognition::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSVoiceRecognition::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSVoiceRecognition::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_AutoDisable( /*[out, retval]*/ VARIANT_BOOL* pAutoDisable )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_AutoDisable( /*[in]*/ VARIANT_BOOL AutoDisable )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_DataCount( /*[out, retval]*/ LONG* pDataCount )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_DataEventEnabled( /*[out, retval]*/ VARIANT_BOOL* pDataEventEnabled )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_DataEventEnabled( /*[in]*/ VARIANT_BOOL DataEventEnabled )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSVoiceRecognition::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSVoiceRecognition::get_CapLanguage( /*[out, retval]*/ VARIANT_BOOL* pCapLanguage )
{
    return GetOposProp( DEBUGPARAM("CapLanguage") PIDXVrcg_CapLanguage, pCapLanguage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_HearingDataPattern( /*[out, retval]*/ BSTR* pHearingDataPattern )
{
    return GetOposProp( DEBUGPARAM("HearingDataPattern") PIDXVrcg_HearingDataPattern, pHearingDataPattern, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_HearingDataWord( /*[out, retval]*/ BSTR* pHearingDataWord )
{
    return GetOposProp( DEBUGPARAM("HearingDataWord") PIDXVrcg_HearingDataWord, pHearingDataWord, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_HearingDataWordList( /*[out, retval]*/ BSTR* pHearingDataWordList )
{
    return GetOposProp( DEBUGPARAM("HearingDataWordList") PIDXVrcg_HearingDataWordList, pHearingDataWordList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_HearingResult( /*[out, retval]*/ LONG* pHearingResult )
{
    return GetOposProp( DEBUGPARAM("HearingResult") PIDXVrcg_HearingResult, pHearingResult, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_HearingStatus( /*[out, retval]*/ LONG* pHearingStatus )
{
    return GetOposProp( DEBUGPARAM("HearingStatus") PIDXVrcg_HearingStatus, pHearingStatus, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVoiceRecognition::get_LanguageList( /*[out, retval]*/ BSTR* pLanguageList )
{
    return GetOposProp( DEBUGPARAM("LanguageList") PIDXVrcg_LanguageList, pLanguageList, 16 /*MinorVersion*/ );
}
...
void COPOSVoiceRecognition::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_VoiceRecognition.log");
...
#define OPOSCCOCLASS COPOSVoiceRecognition
#define RCSTRACENAME "OposCCO_VoiceRecognition"
...
void COPOSVoiceRecognition::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSVoiceRecognition::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSVoiceRecognition::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSVoiceRecognition::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
