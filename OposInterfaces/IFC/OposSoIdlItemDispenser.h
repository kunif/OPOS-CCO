//*************************************************************************
//** OPOS ItemDispenser SO Interface
//*************************************************************************
...
dispinterface IOPOSItemDispenserSO
{
    ...
    methods:
     ...
     // [id(12)] LONG ClearOutput(void);
        ...
        [id(81)] LONG AdjustItemCount([in] LONG ItemCount, [in] LONG SlotNumber);
        [id(82)] LONG DispenseItem([in, out] LONG* pNumItem, [in] LONG SlotNumber);
        [id(83)] LONG ReadItemCount([in, out] LONG* pItemCount, [in] LONG SlotNumber);
};
