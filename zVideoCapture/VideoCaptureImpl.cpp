/****************************************************************************
**
** VideoCaptureImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSVideoCapture");

// Control Object description and version.
char g_ControlDescription[] = "OPOS VideoCapture Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSVideoCapture::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "StartVideoRecording",
        #define nDIStartVideo 17
    "StopVideoRecording",
        #define nDIStopVideo 18
    "TakePhotograph",
        #define nDITakePhoto 19
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS VideoCapture.
//===========================================================================
...
const int MinorReleaseInitial = 16;
...
COPOSVideoCapture::COPOSVideoCapture()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSVideoCapture >(this) )
{
}

//===========================================================================

HRESULT COPOSVideoCapture::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSVideoCapture::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSVideoCapture::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSVIDEOCAPTURE2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSVideoCapture::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSVideoCapture::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSVideoCapture::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSVideoCapture::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSVideoCapture::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_VCAP );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_VCAP), hRC );
...
STDMETHODIMP COPOSVideoCapture::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVideoCapture::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVideoCapture::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSVideoCapture::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSVideoCapture::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVideoCapture::ClearInput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSVideoCapture::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSVideoCapture::ResetStatistics( 
...
STDMETHODIMP COPOSVideoCapture::RetrieveStatistics( 
...
STDMETHODIMP COPOSVideoCapture::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVideoCapture::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSVideoCapture::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSVideoCapture::StartVideo( 
    /*[in]*/ BSTR FileName, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    Vars[1].SetVARIANT_BOOL( OverWrite );
    Vars[0].SetLONG( RecordingTime );
    return DoInvoke( DEBUGPARAM("StartVideo") hRC, Vars, 3, nDIStartVideo, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::StopVideo( 
    /*[out, retval]*/ long* pRC )
{
    return DoInvoke( DEBUGPARAM("StopVideo") S_OK, NULL, 0, nDIStopVideo, pRC );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::TakePhoto( 
    /*[in]*/ BSTR FileName, 
    /*[in]*/ VARIANT_BOOL OverWrite, 
    /*[in]*/ LONG Timeout, 
    /*[out, retval]*/ long* pRC )
{
    ...
    return DoInvoke( DEBUGPARAM("TakePhoto") hRC, Vars, 2, nDITakePhoto, pRC );
}
...
STDMETHODIMP COPOSVideoCapture::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSVideoCapture::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSVideoCapture::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSVideoCapture::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSVideoCapture::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSVideoCapture::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSVideoCapture::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSVideoCapture::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
    return GetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, pBinaryConversion, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
    IFDEBUG( _nBinaryConversion = BinaryConversion);
    return SetOposProp( DEBUGPARAM("BinaryConversion") PIDX_BinaryConversion, BinaryConversion, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
    return GetOposProp( DEBUGPARAM("CapPowerReporting") PIDX_CapPowerReporting, pCapPowerReporting, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
    return GetOposProp( DEBUGPARAM("CheckHealthText") PIDX_CheckHealthText, pCheckHealthText, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
    return GetOposProp( DEBUGPARAM("Claimed") PIDX_Claimed, pClaimed, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
    return GetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, pDeviceEnabled, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
    return SetOposProp( DEBUGPARAM("DeviceEnabled") PIDX_DeviceEnabled, DeviceEnabled, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
    return GetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, pPowerNotify, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
    return SetOposProp( DEBUGPARAM("PowerNotify") PIDX_PowerNotify, PowerNotify, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
    return GetOposProp( DEBUGPARAM("PowerState") PIDX_PowerState, pPowerState, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
    return GetOposProp( DEBUGPARAM("ResultCodeExtended") PIDX_ResultCodeExtended, pResultCodeExtended, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectDescription") PIDX_ServiceObjectDescription, pServiceObjectDescription, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
    return GetOposProp( DEBUGPARAM("ServiceObjectVersion") PIDX_ServiceObjectVersion, pServiceObjectVersion, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
    return GetOposProp( DEBUGPARAM("DeviceDescription") PIDX_DeviceDescription, pDeviceDescription, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
    return GetOposProp( DEBUGPARAM("DeviceName") PIDX_DeviceName, pDeviceName, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
    return GetOposProp( DEBUGPARAM("CapStatisticsReporting") PIDX_CapStatisticsReporting, pCapStatisticsReporting, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
    return GetOposProp( DEBUGPARAM("CapUpdateStatistics") PIDX_CapUpdateStatistics, pCapUpdateStatistics, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
    return GetOposProp( DEBUGPARAM("CapCompareFirmwareVersion") PIDX_CapCompareFirmwareVersion, pCapCompareFirmwareVersion, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
    return GetOposProp( DEBUGPARAM("CapUpdateFirmware") PIDX_CapUpdateFirmware, pCapUpdateFirmware, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_AutoExposure( /*[out, retval]*/ VARIANT_BOOL* pAutoExposure )
{
    return GetOposProp( DEBUGPARAM("AutoExposure") PIDXVcap_AutoExposure, pAutoExposure, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_AutoExposure( /*[in]*/ VARIANT_BOOL AutoExposure )
{
    return SetOposProp( DEBUGPARAM("AutoExposure") PIDXVcap_AutoExposure, AutoExposure, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_AutoFocus( /*[out, retval]*/ VARIANT_BOOL* pAutoFocus )
{
    return GetOposProp( DEBUGPARAM("AutoFocus") PIDXVcap_AutoFocus, pAutoFocus, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_AutoFocus( /*[in]*/ VARIANT_BOOL AutoFocus )
{
    return SetOposProp( DEBUGPARAM("AutoFocus") PIDXVcap_AutoFocus, AutoFocus, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_AutoGain( /*[out, retval]*/ VARIANT_BOOL* pAutoGain )
{
    return GetOposProp( DEBUGPARAM("AutoGain") PIDXVcap_AutoGain, pAutoGain, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_AutoGain( /*[in]*/ VARIANT_BOOL AutoGain )
{
    return SetOposProp( DEBUGPARAM("AutoGain") PIDXVcap_AutoGain, AutoGain, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_AutoWhiteBalance( /*[out, retval]*/ VARIANT_BOOL* pAutoWhiteBalance )
{
    return GetOposProp( DEBUGPARAM("AutoWhiteBalance") PIDXVcap_AutoWhiteBalance, pAutoWhiteBalance, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_AutoWhiteBalance( /*[in]*/ VARIANT_BOOL AutoWhiteBalance )
{
    return SetOposProp( DEBUGPARAM("AutoWhiteBalance") PIDXVcap_AutoWhiteBalance, AutoWhiteBalance, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Brightness( /*[out, retval]*/ LONG* pBrightness )
{
    return GetOposProp( DEBUGPARAM("Brightness") PIDXVcap_Brightness, pBrightness, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Brightness( /*[in]*/ LONG Brightness )
{
    return SetOposProp( DEBUGPARAM("Brightness") PIDXVcap_Brightness, Brightness, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapAssociatedHardTotalsDevice( /*[out, retval]*/ BSTR* pCapAssociatedHardTotalsDevice )
{
    return GetOposProp( DEBUGPARAM("CapAssociatedHardTotalsDevice") PIDXVcap_CapAssociatedHardTotalsDevice, pCapAssociatedHardTotalsDevice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapAutoExposure( /*[out, retval]*/ VARIANT_BOOL* pCapAutoExposure )
{
    return GetOposProp( DEBUGPARAM("CapAutoExposure") PIDXVcap_CapAutoExposure, pCapAutoExposure, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapAutoFocus( /*[out, retval]*/ VARIANT_BOOL* pCapAutoFocus )
{
    return GetOposProp( DEBUGPARAM("CapAutoFocus") PIDXVcap_CapAutoFocus, pCapAutoFocus, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapAutoGain( /*[out, retval]*/ VARIANT_BOOL* pCapAutoGain )
{
    return GetOposProp( DEBUGPARAM("CapAutoGain") PIDXVcap_CapAutoGain, pCapAutoGain, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapAutoWhiteBalance( /*[out, retval]*/ VARIANT_BOOL* pCapAutoWhiteBalance )
{
    return GetOposProp( DEBUGPARAM("CapAutoWhiteBalance") PIDXVcap_CapAutoWhiteBalance, pCapAutoWhiteBalance, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapBrightness( /*[out, retval]*/ VARIANT_BOOL* pCapBrightness )
{
    return GetOposProp( DEBUGPARAM("CapBrightness") PIDXVcap_CapBrightness, pCapBrightness, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapContrast( /*[out, retval]*/ VARIANT_BOOL* pCapContrast )
{
    return GetOposProp( DEBUGPARAM("CapContrast") PIDXVcap_CapContrast, pCapContrast, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapExposure( /*[out, retval]*/ VARIANT_BOOL* pCapExposure )
{
    return GetOposProp( DEBUGPARAM("CapExposure") PIDXVcap_CapExposure, pCapExposure, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapGain( /*[out, retval]*/ VARIANT_BOOL* pCapGain )
{
    return GetOposProp( DEBUGPARAM("CapGain") PIDXVcap_CapGain, pCapGain, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapHorizontalFlip( /*[out, retval]*/ VARIANT_BOOL* pCapHorizontalFlip )
{
    return GetOposProp( DEBUGPARAM("CapHorizontalFlip") PIDXVcap_CapHorizontalFlip, pCapHorizontalFlip, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapHue( /*[out, retval]*/ VARIANT_BOOL* pCapHue )
{
    return GetOposProp( DEBUGPARAM("CapHue") PIDXVcap_CapHue, pCapHue, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPhoto( /*[out, retval]*/ VARIANT_BOOL* pCapPhoto )
{
    return GetOposProp( DEBUGPARAM("CapPhoto") PIDXVcap_CapPhoto, pCapPhoto, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPhotoColorSpace( /*[out, retval]*/ VARIANT_BOOL* pCapPhotoColorSpace )
{
    return GetOposProp( DEBUGPARAM("CapPhotoColorSpace") PIDXVcap_CapPhotoColorSpace, pCapPhotoColorSpace, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPhotoFrameRate( /*[out, retval]*/ VARIANT_BOOL* pCapPhotoFrameRate )
{
    return GetOposProp( DEBUGPARAM("CapPhotoFrameRate") PIDXVcap_CapPhotoFrameRate, pCapPhotoFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPhotoResolution( /*[out, retval]*/ VARIANT_BOOL* pCapPhotoResolution )
{
    return GetOposProp( DEBUGPARAM("CapPhotoResolution") PIDXVcap_CapPhotoResolution, pCapPhotoResolution, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapPhotoType( /*[out, retval]*/ VARIANT_BOOL* pCapPhotoType )
{
    return GetOposProp( DEBUGPARAM("CapPhotoType") PIDXVcap_CapPhotoType, pCapPhotoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapSaturation( /*[out, retval]*/ VARIANT_BOOL* pCapSaturation )
{
    return GetOposProp( DEBUGPARAM("CapSaturation") PIDXVcap_CapSaturation, pCapSaturation, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapStorage( /*[out, retval]*/ LONG* pCapStorage )
{
    return GetOposProp( DEBUGPARAM("CapStorage") PIDXVcap_CapStorage, pCapStorage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVerticalFlip( /*[out, retval]*/ VARIANT_BOOL* pCapVerticalFlip )
{
    return GetOposProp( DEBUGPARAM("CapVerticalFlip") PIDXVcap_CapVerticalFlip, pCapVerticalFlip, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVideo( /*[out, retval]*/ VARIANT_BOOL* pCapVideo )
{
    return GetOposProp( DEBUGPARAM("CapVideo") PIDXVcap_CapVideo, pCapVideo, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVideoColorSpace( /*[out, retval]*/ VARIANT_BOOL* pCapVideoColorSpace )
{
    return GetOposProp( DEBUGPARAM("CapVideoColorSpace") PIDXVcap_CapVideoColorSpace, pCapVideoColorSpace, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVideoFrameRate( /*[out, retval]*/ VARIANT_BOOL* pCapVideoFrameRate )
{
    return GetOposProp( DEBUGPARAM("CapVideoFrameRate") PIDXVcap_CapVideoFrameRate, pCapVideoFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVideoResolution( /*[out, retval]*/ VARIANT_BOOL* pCapVideoResolution )
{
    return GetOposProp( DEBUGPARAM("CapVideoResolution") PIDXVcap_CapVideoResolution, pCapVideoResolution, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_CapVideoType( /*[out, retval]*/ VARIANT_BOOL* pCapVideoType )
{
    return GetOposProp( DEBUGPARAM("CapVideoType") PIDXVcap_CapVideoType, pCapVideoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Contrast( /*[out, retval]*/ LONG* pContrast )
{
    return GetOposProp( DEBUGPARAM("Contrast") PIDXVcap_Contrast, pContrast, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Contrast( /*[in]*/ LONG Contrast )
{
    return SetOposProp( DEBUGPARAM("Contrast") PIDXVcap_Contrast, Contrast, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Exposure( /*[out, retval]*/ LONG* pExposure )
{
    return GetOposProp( DEBUGPARAM("Exposure") PIDXVcap_Exposure, pExposure, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Exposure( /*[in]*/ LONG Exposure )
{
    return SetOposProp( DEBUGPARAM("Exposure") PIDXVcap_Exposure, Exposure, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Gain( /*[out, retval]*/ LONG* pGain )
{
    return GetOposProp( DEBUGPARAM("Gain") PIDXVcap_Gain, pGain, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Gain( /*[in]*/ LONG Gain )
{
    return SetOposProp( DEBUGPARAM("Gain") PIDXVcap_Gain, Gain, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_HorizontalFlip( /*[out, retval]*/ VARIANT_BOOL* pHorizontalFlip )
{
    return GetOposProp( DEBUGPARAM("HorizontalFlip") PIDXVcap_HorizontalFlip, pHorizontalFlip, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_HorizontalFlip( /*[in]*/ VARIANT_BOOL HorizontalFlip )
{
    return SetOposProp( DEBUGPARAM("HorizontalFlip") PIDXVcap_HorizontalFlip, HorizontalFlip, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Hue( /*[out, retval]*/ LONG* pHue )
{
    return GetOposProp( DEBUGPARAM("Hue") PIDXVcap_Hue, pHue, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Hue( /*[in]*/ LONG Hue )
{
    return SetOposProp( DEBUGPARAM("Hue") PIDXVcap_Hue, Hue, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoColorSpace( /*[out, retval]*/ BSTR* pPhotoColorSpace )
{
    return GetOposProp( DEBUGPARAM("PhotoColorSpace") PIDXVcap_PhotoColorSpace, pPhotoColorSpace, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_PhotoColorSpace( /*[in]*/ BSTR PhotoColorSpace )
{
    return SetOposProp( DEBUGPARAM("PhotoColorSpace") PIDXVcap_PhotoColorSpace, PhotoColorSpace, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoColorSpaceList( /*[out, retval]*/ BSTR* pPhotoColorSpaceList )
{
    return GetOposProp( DEBUGPARAM("PhotoColorSpaceList") PIDXVcap_PhotoColorSpaceList, pPhotoColorSpaceList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoFrameRate( /*[out, retval]*/ LONG* pPhotoFrameRate )
{
    return GetOposProp( DEBUGPARAM("PhotoFrameRate") PIDXVcap_PhotoFrameRate, pPhotoFrameRate, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_PhotoFrameRate( /*[in]*/ LONG PhotoFrameRate )
{
    return SetOposProp( DEBUGPARAM("PhotoFrameRate") PIDXVcap_PhotoFrameRate, PhotoFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoMaxFrameRate( /*[out, retval]*/ LONG* pPhotoMaxFrameRate )
{
    return GetOposProp( DEBUGPARAM("PhotoMaxFrameRate") PIDXVcap_PhotoMaxFrameRate, pPhotoMaxFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoResolution( /*[out, retval]*/ BSTR* pPhotoResolution )
{
    return GetOposProp( DEBUGPARAM("PhotoResolution") PIDXVcap_PhotoResolution, pPhotoResolution, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_PhotoResolution( /*[in]*/ BSTR PhotoResolution )
{
    return SetOposProp( DEBUGPARAM("PhotoResolution") PIDXVcap_PhotoResolution, PhotoResolution, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoResolutionList( /*[out, retval]*/ BSTR* pPhotoResolutionList )
{
    return GetOposProp( DEBUGPARAM("PhotoResolutionList") PIDXVcap_PhotoResolutionList, pPhotoResolutionList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoType( /*[out, retval]*/ BSTR* pPhotoType )
{
    return GetOposProp( DEBUGPARAM("PhotoType") PIDXVcap_PhotoType, pPhotoType, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_PhotoType( /*[in]*/ BSTR PhotoType )
{
    return SetOposProp( DEBUGPARAM("PhotoType") PIDXVcap_PhotoType, PhotoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_PhotoTypeList( /*[out, retval]*/ BSTR* pPhotoTypeList )
{
    return GetOposProp( DEBUGPARAM("PhotoTypeList") PIDXVcap_PhotoTypeList, pPhotoTypeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_RemainingRecordingTimeInSec( /*[out, retval]*/ LONG* pRemainingRecordingTimeInSec )
{
    return GetOposProp(DEBUGPARAM("RemainingRecordingTimeInSec") PIDXVcap_RemainingRecordingTimeInSec, pRemainingRecordingTimeInSec, 16 /*MinorVersion*/);
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Saturation( /*[out, retval]*/ LONG* pSaturation )
{
    return GetOposProp( DEBUGPARAM("Saturation") PIDXVcap_Saturation, pSaturation, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Saturation( /*[in]*/ LONG Saturation )
{
    return SetOposProp( DEBUGPARAM("Saturation") PIDXVcap_Saturation, Saturation, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_Storage( /*[out, retval]*/ LONG* pStorage )
{
    return GetOposProp( DEBUGPARAM("Storage") PIDXVcap_Storage, pStorage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_Storage( /*[in]*/ LONG Storage )
{
    return SetOposProp( DEBUGPARAM("Storage") PIDXVcap_Storage, Storage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VerticalFlip( /*[out, retval]*/ VARIANT_BOOL* pVerticalFlip )
{
    return GetOposProp( DEBUGPARAM("VerticalFlip") PIDXVcap_VerticalFlip, pVerticalFlip, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VerticalFlip( /*[in]*/ VARIANT_BOOL VerticalFlip )
{
    return SetOposProp( DEBUGPARAM("VerticalFlip") PIDXVcap_VerticalFlip, VerticalFlip, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoCaptureMode( /*[out, retval]*/ LONG* pVideoCaptureMode )
{
    return GetOposProp( DEBUGPARAM("VideoCaptureMode") PIDXVcap_VideoCaptureMode, pVideoCaptureMode, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VideoCaptureMode( /*[in]*/ LONG VideoCaptureMode )
{
    return SetOposProp( DEBUGPARAM("VideoCaptureMode") PIDXVcap_VideoCaptureMode, VideoCaptureMode, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoColorSpace( /*[out, retval]*/ BSTR* pVideoColorSpace )
{
    return GetOposProp( DEBUGPARAM("VideoColorSpace") PIDXVcap_VideoColorSpace, pVideoColorSpace, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VideoColorSpace( /*[in]*/ BSTR VideoColorSpace )
{
    return SetOposProp( DEBUGPARAM("VideoColorSpace") PIDXVcap_VideoColorSpace, VideoColorSpace, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoColorSpaceList( /*[out, retval]*/ BSTR* pVideoColorSpaceList )
{
    return GetOposProp( DEBUGPARAM("VideoColorSpaceList") PIDXVcap_VideoColorSpaceList, pVideoColorSpaceList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoFrameRate( /*[out, retval]*/ LONG* pVideoFrameRate )
{
    return GetOposProp( DEBUGPARAM("VideoFrameRate") PIDXVcap_VideoFrameRate, pVideoFrameRate, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VideoFrameRate( /*[in]*/ LONG VideoFrameRate )
{
    return SetOposProp( DEBUGPARAM("VideoFrameRate") PIDXVcap_VideoFrameRate, VideoFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoMaxFrameRate( /*[out, retval]*/ LONG* pVideoMaxFrameRate )
{
    return GetOposProp( DEBUGPARAM("VideoMaxFrameRate") PIDXVcap_VideoMaxFrameRate, pVideoMaxFrameRate, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoResolution( /*[out, retval]*/ BSTR* pVideoResolution )
{
    return GetOposProp( DEBUGPARAM("VideoResolution") PIDXVcap_VideoResolution, pVideoResolution, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VideoResolution( /*[in]*/ BSTR VideoResolution )
{
    return SetOposProp( DEBUGPARAM("VideoResolution") PIDXVcap_VideoResolution, VideoResolution, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoResolutionList( /*[out, retval]*/ BSTR* pVideoResolutionList )
{
    return GetOposProp( DEBUGPARAM("VideoResolutionList") PIDXVcap_VideoResolutionList, pVideoResolutionList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoType( /*[out, retval]*/ BSTR* pVideoType )
{
    return GetOposProp( DEBUGPARAM("VideoType") PIDXVcap_VideoType, pVideoType, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSVideoCapture::put_VideoType( /*[in]*/ BSTR VideoType )
{
    return SetOposProp( DEBUGPARAM("VideoType") PIDXVcap_VideoType, VideoType, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSVideoCapture::get_VideoTypeList( /*[out, retval]*/ BSTR* pVideoTypeList )
{
    return GetOposProp( DEBUGPARAM("VideoTypeList") PIDXVcap_VideoTypeList, pVideoTypeList, 16 /*MinorVersion*/ );
}
...
void COPOSVideoCapture::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_VideoCapture.log");
...
#define OPOSCCOCLASS COPOSVideoCapture
#define RCSTRACENAME "OposCCO_VideoCapture"
...
void COPOSVideoCapture::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSVideoCapture::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSVideoCapture::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSVideoCapture::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
