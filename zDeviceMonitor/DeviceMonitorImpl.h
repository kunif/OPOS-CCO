/****************************************************************************
**
** DeviceMonitorImpl.h -- Main control header file.
**
...
//#define _FILETRACE // Uncomment to use C runtime writes to a file.
    ...
    #ifdef _FILETRACE
        #pragma message("===>>> Debug Build: Slow tracing to C:\\OposCCO_DeviceMonitor.log")
        #define DOTRACEV(x) WriteTrace x
        #define DODUMPV(x,y)            // Dump of non-ASCII data not implemented.
        #define TRACEINIT
        #define TRACEEXIT
    #else
        #pragma message("===>>> Debug Build: Fast tracing to OposCCO_DeviceMonitor.log")
...
// The class...
class ATL_NO_VTABLE COPOSDeviceMonitor :
    // Inherit from all these classes...
    public CComObjectRootEx<CComSingleThreadModel>,
    public IDispatchImpl<IOPOSDeviceMonitor, &IID_IOPOSDeviceMonitor, &LIBID_OposDeviceMonitor_CCO>,
    public CComControl<COPOSDeviceMonitor>,
    public IPersistStreamInitImpl<COPOSDeviceMonitor>,
    public IOleControlImpl<COPOSDeviceMonitor>,
    public IOleObjectImpl<COPOSDeviceMonitor>,
    public IOleInPlaceActiveObjectImpl<COPOSDeviceMonitor>,
    public IViewObjectExImpl<COPOSDeviceMonitor>,
    public IOleInPlaceObjectWindowlessImpl<COPOSDeviceMonitor>,
    public IConnectionPointContainerImpl<COPOSDeviceMonitor>,
    public IPersistStorageImpl<COPOSDeviceMonitor>,
    public ISpecifyPropertyPagesImpl<COPOSDeviceMonitor>,
    public IQuickActivateImpl<COPOSDeviceMonitor>,
    public IDataObjectImpl<COPOSDeviceMonitor>,
    public IProvideClassInfo2Impl<&CLSID_OPOSDeviceMonitor, &DIID__IOPOSDeviceMonitorEvents, &LIBID_OposDeviceMonitor_CCO>,
    public IObjectSafetyImpl<COPOSDeviceMonitor, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
    public IPropertyNotifySinkCP<COPOSDeviceMonitor>,
    public CComCoClass<COPOSDeviceMonitor, &CLSID_OPOSDeviceMonitor>,
    public CProxy_IOPOSEvents< COPOSDeviceMonitor >
{
public:
...
public:
    // Registry resource.
DECLARE_REGISTRY_RESOURCEID(IDR_OPOSDEVICEMONITOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

    // Define supported interfaces.
BEGIN_COM_MAP(COPOSDeviceMonitor)
    //  Map COM dispatch to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IDispatch, IOPOSDeviceMonitor)
    //   Map each COM interface to the current interface implementation.
    COM_INTERFACE_ENTRY_IID(IID_IOPOSDeviceMonitor, IOPOSDeviceMonitor)
    COM_INTERFACE_ENTRY_IID(IID_IOPOSDeviceMonitor_1_16, IOPOSDeviceMonitor)
...
END_COM_MAP()
    ...
    // Define property map.
BEGIN_PROP_MAP(COPOSDeviceMonitor)
    PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
    PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
END_PROP_MAP()

    // Define connection points.
BEGIN_CONNECTION_POINT_MAP(COPOSDeviceMonitor)
    CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
    CONNECTION_POINT_ENTRY(DIID__IOPOSDeviceMonitorEvents)
END_CONNECTION_POINT_MAP()

    // Define message map.
BEGIN_MSG_MAP(COPOSDeviceMonitor)
    CHAIN_MSG_MAP(CComControl<COPOSDeviceMonitor>)
...
// Release 1.16
    ...
    STDMETHOD(ClearInputProperties)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(get_DeviceData)( /*[out, retval]*/ BSTR* pDeviceData );
    STDMETHOD(get_DeviceList)( /*[out, retval]*/ BSTR* pDeviceList );
    STDMETHOD(get_MonitoringDeviceList)( /*[out, retval]*/ BSTR* pMonitoringDeviceList );
    STDMETHOD(AddMonitoringDevice)( 
        /*[in]*/ BSTR DeviceID, 
        ...
        /*[out, retval]*/ long* pRC );
    STDMETHOD(ClearMonitoringDevice)( 
        /*[out, retval]*/ long* pRC );
    STDMETHOD(DeleteMonitoringDevice)( 
        /*[in]*/ BSTR DeviceID, 
        /*[out, retval]*/ long* pRC );
