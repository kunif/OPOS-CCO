//*************************************************************************
//** OPOS SmartCardRW SO Interface
//*************************************************************************

[
    uuid(CCBE0250-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSSmartCardRWSO 1.16 Interface")
]
dispinterface IOPOSSmartCardRWSO
{
    ...
    methods:
        ...
        [id(83)] LONG EndInsertion(void);
        [id(84)] LONG EndRemoval(void);
        [id(85)] LONG ReadData([in] LONG Action, [in, out] LONG* pCount, [in, out] BSTR* pData);
        [id(86)] LONG WriteData([in] LONG Action, [in] LONG Count, [in] BSTR Data);
};
