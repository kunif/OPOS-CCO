/****************************************************************************
**
** SoundPlayerImpl.cpp -- Main control implementation file.
**
...
TCHAR g_WindowName[] = _T("HW_OPOSSoundPlayer");

// Control Object description and version.
char g_ControlDescription[] = "OPOS SoundPlayer Control 1.16.000 [Public, by KF]" IFDEBUG(" [With Tracing]");
...
int COPOSSoundPlayer::s_nInstances = 0;
...
// Release 1.16 methods
    ...
    "PlaySound",
        #define nDIPlaySound 17
    "StopSound",
        #define nDIStopSound 18
    0
};
...
//   for each release.
// Followed by the initial minor release of the OPOS SoundPlayer.
//===========================================================================
...
COPOSSoundPlayer::COPOSSoundPlayer()
    IFDEBUG( : CProxy_IOPOSEvents< COPOSSoundPlayer >(this) )
{
}

//===========================================================================

HRESULT COPOSSoundPlayer::FinalConstruct()
{
    TRACEINIT;
    DOTRACE( ( _T("") ) );
...
STDMETHODIMP COPOSSoundPlayer::FreezeEvents( BOOL bFreeze )
{
...
HRESULT COPOSSoundPlayer::OnDraw( ATL_DRAWINFO& di )
{
    ...
    HBITMAP hBitmap = LoadBitmap(
        ...
        MAKEINTRESOURCE(IDB_OPOSSOUNDPLAYER2) ); // bitmap resource name
    BITMAP bmp;
    GetObject(
...
HRESULT COPOSSoundPlayer::GetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSoundPlayer::SetOposProp( DEBUGPARAM(LPCSTR pPropName)
...
HRESULT COPOSSoundPlayer::DoInvoke( DEBUGPARAM(LPCSTR pFuncName)
...
void COPOSSoundPlayer::SetCOFreezeEvents( VARIANT_BOOL bFreeze )
{
    // If open...
    if ( _bOpened )
    {
...
STDMETHODIMP COPOSSoundPlayer::Open( BSTR DeviceName, long *pRC )
{
    HRESULT hRC;
    LONG nError;
    ...
    *pRC = SetRC( OPOS_E_NOEXIST );
    ...
    HKEY hBaseKey;
    cw_strcpy( szBaseKey, OPOS_ROOTKEY "\\" OPOS_CLASSKEY_SPLY );
    nError = RegOpenKeyEx(
    ...
    *pRC = SetRC( OPOS_E_NOSERVICE );
    ...
    OposVariant Vars[3];
    Vars[2].SetString( _CW(OPOS_CLASSKEY_SPLY), hRC );
...
STDMETHODIMP COPOSSoundPlayer::Close( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundPlayer::ClaimDevice( long Timeout, long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundPlayer::ReleaseDevice( long *pRC )
{
    SetRC();
...
STDMETHODIMP COPOSSoundPlayer::SOProcessID( long *pProcessID )
{
...
STDMETHODIMP COPOSSoundPlayer::CheckHealth( 
    /*[in]*/ LONG Level, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundPlayer::ClearOutput( 
    /*[out, retval]*/ long* pRC )
{
...
STDMETHODIMP COPOSSoundPlayer::DirectIO( 
    /*[in]*/ LONG Command, 
    /*[in, out]*/ LONG* pData, 
    /*[in, out]*/ BSTR* pString, 
    /*[out, retval]*/ long* pRC )
...
STDMETHODIMP COPOSSoundPlayer::ResetStatistics( 
...
STDMETHODIMP COPOSSoundPlayer::RetrieveStatistics( 
...
STDMETHODIMP COPOSSoundPlayer::UpdateStatistics( 
    /*[in]*/ BSTR StatisticsBuffer, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundPlayer::CompareFirmwareVersion( 
...
STDMETHODIMP COPOSSoundPlayer::UpdateFirmware( 
    /*[in]*/ BSTR FirmwareFileName, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
...
STDMETHODIMP COPOSSoundPlayer::PlaySound( 
    /*[in]*/ BSTR FileName, 
    ...
    /*[out, retval]*/ long* pRC )
{
    ...
    return DoInvoke( DEBUGPARAM("PlaySound") hRC, Vars, 2, nDIPlaySound, pRC );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::StopSound( 
    /*[in]*/ LONG OutputID, 
    /*[out, retval]*/ long* pRC )
{
    OposVariant Var;
    Var.SetLONG( OutputID );
    return DoInvoke( DEBUGPARAM("StopSound") S_OK, &Var, 1, nDIStopSound, pRC );
}
...
STDMETHODIMP COPOSSoundPlayer::get_FreezeEvents( VARIANT_BOOL *pFreezeEvents )
{
...
STDMETHODIMP COPOSSoundPlayer::put_FreezeEvents( VARIANT_BOOL FreezeEvents )
{
    SetRC();
...
STDMETHODIMP COPOSSoundPlayer::get_ResultCode( long *pResultCode )
{
...
STDMETHODIMP COPOSSoundPlayer::get_State( long *pState )
{
    if ( ! _bOpened )                           // If not open,
    {
...
STDMETHODIMP COPOSSoundPlayer::get_ControlObjectDescription( BSTR *pControlObjectDescription )
{
...
STDMETHODIMP COPOSSoundPlayer::get_ControlObjectVersion( long *pControlObjectVersion )
{
...
STDMETHODIMP COPOSSoundPlayer::get_OpenResult( long *pOpenResult )
{
...
STDMETHODIMP COPOSSoundPlayer::get_BinaryConversion( /*[out, retval]*/ LONG* pBinaryConversion )
{
...
STDMETHODIMP COPOSSoundPlayer::put_BinaryConversion( /*[in]*/ LONG BinaryConversion )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapPowerReporting( /*[out, retval]*/ LONG* pCapPowerReporting )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CheckHealthText( /*[out, retval]*/ BSTR* pCheckHealthText )
{
...
STDMETHODIMP COPOSSoundPlayer::get_Claimed( /*[out, retval]*/ VARIANT_BOOL* pClaimed )
{
...
STDMETHODIMP COPOSSoundPlayer::get_DeviceEnabled( /*[out, retval]*/ VARIANT_BOOL* pDeviceEnabled )
{
...
STDMETHODIMP COPOSSoundPlayer::put_DeviceEnabled( /*[in]*/ VARIANT_BOOL DeviceEnabled )
{
...
STDMETHODIMP COPOSSoundPlayer::get_OutputID( /*[out, retval]*/ LONG* pOutputID )
{
...
STDMETHODIMP COPOSSoundPlayer::get_PowerNotify( /*[out, retval]*/ LONG* pPowerNotify )
{
...
STDMETHODIMP COPOSSoundPlayer::put_PowerNotify( /*[in]*/ LONG PowerNotify )
{
...
STDMETHODIMP COPOSSoundPlayer::get_PowerState( /*[out, retval]*/ LONG* pPowerState )
{
...
STDMETHODIMP COPOSSoundPlayer::get_ResultCodeExtended( /*[out, retval]*/ LONG* pResultCodeExtended )
{
...
STDMETHODIMP COPOSSoundPlayer::get_ServiceObjectDescription( /*[out, retval]*/ BSTR* pServiceObjectDescription )
{
...
STDMETHODIMP COPOSSoundPlayer::get_ServiceObjectVersion( /*[out, retval]*/ LONG* pServiceObjectVersion )
{
...
STDMETHODIMP COPOSSoundPlayer::get_DeviceDescription( /*[out, retval]*/ BSTR* pDeviceDescription )
{
...
STDMETHODIMP COPOSSoundPlayer::get_DeviceName( /*[out, retval]*/ BSTR* pDeviceName )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapStatisticsReporting( /*[out, retval]*/ VARIANT_BOOL* pCapStatisticsReporting )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapUpdateStatistics( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateStatistics )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapCompareFirmwareVersion( /*[out, retval]*/ VARIANT_BOOL* pCapCompareFirmwareVersion )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapUpdateFirmware( /*[out, retval]*/ VARIANT_BOOL* pCapUpdateFirmware )
{
...
STDMETHODIMP COPOSSoundPlayer::get_CapAssociatedHardTotalsDevice( /*[out, retval]*/ BSTR* pCapAssociatedHardTotalsDevice )
{
    return GetOposProp( DEBUGPARAM("CapAssociatedHardTotalsDevice") PIDXSply_CapAssociatedHardTotalsDevice, pCapAssociatedHardTotalsDevice, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_CapMultiPlay( /*[out, retval]*/ VARIANT_BOOL* pCapMultiPlay )
{
    return GetOposProp( DEBUGPARAM("CapMultiPlay") PIDXSply_CapMultiPlay, pCapMultiPlay, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_CapSoundTypeList( /*[out, retval]*/ BSTR* pCapSoundTypeList )
{
    return GetOposProp( DEBUGPARAM("CapSoundTypeList") PIDXSply_CapSoundTypeList, pCapSoundTypeList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_CapStorage( /*[out, retval]*/ LONG* pCapStorage )
{
    return GetOposProp( DEBUGPARAM("CapStorage") PIDXSply_CapStorage, pCapStorage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_CapVolume( /*[out, retval]*/ VARIANT_BOOL* pCapVolume )
{
    return GetOposProp( DEBUGPARAM("CapVolume") PIDXSply_CapVolume, pCapVolume, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_DeviceSoundList( /*[out, retval]*/ BSTR* pDeviceSoundList )
{
    return GetOposProp( DEBUGPARAM("DeviceSoundList") PIDXSply_DeviceSoundList, pDeviceSoundList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_OutputIDList( /*[out, retval]*/ BSTR* pOutputIDList )
{
    return GetOposProp( DEBUGPARAM("OutputIDList") PIDXSply_OutputIDList, pOutputIDList, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_Storage( /*[out, retval]*/ LONG* pStorage )
{
    return GetOposProp( DEBUGPARAM("Storage") PIDXSply_Storage, pStorage, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundPlayer::put_Storage( /*[in]*/ LONG Storage )
{
    return SetOposProp( DEBUGPARAM("Storage") PIDXSply_Storage, Storage, 16 /*MinorVersion*/ );
}

//===========================================================================

STDMETHODIMP COPOSSoundPlayer::get_Volume( /*[out, retval]*/ LONG* pVolume )
{
    return GetOposProp( DEBUGPARAM("Volume") PIDXSply_Volume, pVolume, 16 /*MinorVersion*/ );
}

//---------------------------------------------------------------------------

STDMETHODIMP COPOSSoundPlayer::put_Volume( /*[in]*/ LONG Volume )
{
    return SetOposProp( DEBUGPARAM("Volume") PIDXSply_Volume, Volume, 16 /*MinorVersion*/ );
}
...
void COPOSSoundPlayer::WriteTrace( LPCTSTR pFormat, ... )
{
    static TCHAR s_TraceFile[] = _T("C:\\OposCCO_SoundPlayer.log");
...
#define OPOSCCOCLASS COPOSSoundPlayer
#define RCSTRACENAME "OposCCO_SoundPlayer"
...
void COPOSSoundPlayer::WriteTraceError( LPCTSTR pFormat, DWORD dwError )
{
    if ( dwError != 0 )
    {
...
void COPOSSoundPlayer::WriteTraceMethods( DISPID* pDispID, int nMethods )
{
...
//## Output string.
void COPOSSoundPlayer::WriteTraceString( LPCTSTR pszPrefix, BSTR bstr )
{
    // Get string length.
...
void COPOSSoundPlayer::WriteTraceString( void* pString, int nLen, BOOL bAscii, int nCharSize,
    LPCTSTR pszFormat, ... )
{
