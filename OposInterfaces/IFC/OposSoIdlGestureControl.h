//*************************************************************************
//** OPOS GestureControl SO Interface
//*************************************************************************

[
    uuid(CCBE0390-B81E-11D2-AB74-0040054C3719),
    helpstring("IOPOSGestureControlSO 1.16 Interface")
]
dispinterface IOPOSGestureControlSO
{
    properties:
    methods:
     ...
     // [id(11)] LONG ClearInputProperties(void);
        ...
        [id(81)] LONG CreateMotion([in] BSTR FileName, [in] BSTR PoseList);
        [id(82)] LONG CreatePose([in] BSTR FileName, [in] LONG Time);
        [id(83)] LONG GetPosition([in] BSTR JointID, [out] LONG* pPosition);
        [id(84)] LONG SetPosition([in] BSTR PositionList, [in] LONG Time, [in] VARIANT_BOOL Absolute);
        [id(85)] LONG SetSpeed([in] BSTR SpeedList, [in] LONG Time);
        [id(86)] LONG StartMotion([in] BSTR FileName);
        [id(87)] LONG StartPose([in] BSTR FileName);
        [id(88)] LONG StopControl([in] LONG OutputID);
};
